<template>
  <div class="rule">
    ...
    <div class="gifts" v-if="type == 1">
      ...
      <h6>第十一-三十名：</h6>
      <p>歡樂嘉年華徽章（15天）+紅毯座駕（1個月）+500金幣+1000金豆方均可獲得的獎勵</p>
      <h5>助攻VIP-等級獎勵</h5>
      ...
      <h6>第三名：</h6>
      <p>歡歌助攻MVP認證（3個月）+助攻MVP徽章（1個月）+紅毯座駕（1個月）+助攻MVP頭飾（1個月）+會員VIP（1個月）+彩虹獨角獸背包禮物（399金幣）*3+3000金幣+300金豆</p>
      <h6>第四-五名：</h6>
      <p>霸道總裁徽章（30天）+200金幣+500金豆</p>
      <h6>第六-十名：</h6>
    ...
    <div class="ruleItem" v-else>
      ...
      <p>
        1、通過完成每日任務可獲得盛典幣，盛典幣自動到賬，獲得盛典幣活動期間內有效<br />
        2、盛典幣可用于抽獎，抽中獎勵即時到賬<br />
        3、抽中的歡卡為年度人物評選活動的投票券，可在年度人物評選活動投出
      </p>
      <h6>抽獎好禮多-歡樂嘉年華榜單排名規則</h6>
      <p>1、根據報名後獲得的歡樂值排名，歡樂值=使用的盛典幣數量；若分數相同，先達到的排名在前面</p>
      <h5>助攻MVP</h5>
      <h6 class="minTop">助攻MVP-規則</h6>
      <p>1、送出1金幣禮物累計1助攻值，助攻值達到1000、10000、50000、100000、200000、300000、400000、500000可以可以領取對應的寶箱獎勵</p>
      ...
      <p>1、以下活動指定之間段，21:00:00-21:10:00獲得的分數額外加成10%</p>
      <h6>最強家族戰（名稱暫定）</h6>
      <p class="ytime">X月X日-X月X日</p>
      <h6>最強家族戰（名稱暫定）</h6>
      <p class="ytime">X月X日-X月X日</p>
      <h6>最強家族戰（名稱暫定）</h6>
      <p class="ytime">X月X日-X月X日</p>
