<template>
  <div class="rule">
    ...
    <div class="gift" v-if="type == 1">
      ...
      <h6>發佈作品獎勵：</h6>
      <p>用戶每提交一首打擂歌曲(僅限每日提交的第一首)可獲得1個隨機背包禮物紙風車背包禮物（210金豆）/放飛心情背包禮物（100金豆）/潤喉糖背包禮物（1金幣）/金蓮背包禮物（2金幣）/小情書背包禮物（2金幣）/為你打氣背包禮物（3金幣）/草莓水果茶背包禮物（5金幣）/天使之心背包禮物（5金幣）</p>
      <h6>評委獎勵：</h6>
      <p>評委每天評分前30組歌每組歌曲將獲得5金豆<br />當期每連投8組投中，可隨機獲得一個皇冠車背包禮物（600金豆）/船錨背包禮物（1金幣）/2天VIP/法拉利座駕（2天）</p>
      <h6>評委稱號及特權獎勵：</h6>
