<template>
  <div class="rule">
    ...
    <div class="gift" v-if="type == 1">
      ...
      <h6>本期打擂榜前10名獎勵：</h6>
      <p>第1名</p>
      <p>300金幣+1個月VIP+1000金豆</p>
      <p>第2名</p>
      <p>200金幣+1個月VIP+600金豆</p>
      <p>第3名 </p>
      <p>100金幣+1個月VIP+400金豆</p>
      <p>第4-10名</p>
      <p>50金幣+1個月VIP+200金豆</p>
      <h6>本賽季前100名獎勵：</h6>
      <p>第1-3名：音樂教父</p>
      <p>音樂教父徽章+600金幣+VIP（1個月）+1200金豆</p>
      <p>第4-10名：音樂大師</p>
      <p>音樂大師徽章+500金幣+背包禮物2+VIP（1個月）+1000金豆</p>
      <p>第11-50名：音樂明星 </p>
      <p>音樂明星徽章+300金幣+VIP（1個月）+600金豆</p>
      <p>第51-100：音樂達人</p>
      <p>音樂達人徽章+100金幣+VIP（1個月）+300金豆</p>
      <h6>評委獎勵：</h6>
      <p>評委每天評分前30組歌每組歌曲將獲得2金豆<br />當期每連投8組投中，可隨機獲得一個音樂盒背包禮物（360金豆）/棉花糖背包禮物（1金幣）/2天VIP/赤鷹戰機座駕（2天）</p>
      <h6>評委稱號及特權獎勵：</h6>
      ...
      <h6>獎勵說明：</h6>
      <p>1、背包禮物獎勵有效期為14天</p>
      <p>2、評委金豆獎勵即時發放，連投獎勵將由系統在活動結束時發放，本期打擂榜前10名將在活動結束後7天內發放，本賽季前100名獎勵將在本賽季活動結束後7天內發放</p>
    </div>
    <div class="ruleTips" v-else>
      ...
      <div class="mTips">
        ...
        <p>4、每期可選擇多首伴奏參加打擂</p>
        <p>5、若成功選擇打擂歌曲參賽並匹配打擂對手後，刪除該打擂歌曲作品，視為自動棄權，雙方該歌曲打擂成績均失效，另一方將參與下一輪的匹配重新參與打擂</p>
        <p>6、系統會自動匹配相同曲目的兩個參賽選手組成一組，推送給大眾評委進行盲選投票，截止活動結束，每一首歌曲獲得票數多的選手獲勝</p>
        <p>7、若一首歌曲中，兩位選手的總票數超過50，且某一方獲得80%及以上的票數時（即某一方獲得的票數/該歌曲雙方票數之和*100%>=80%），贏的一方可增加2分，輸的人只減1分；若雙方該歌曲的票數之和沒有達到50或者贏的一方獲得的票數沒有達到80%，贏的一方可增加1分，而失敗的則減1分；平票的話，雙方均不加分也不減分，投票的用戶也不算投中</p>
      </div>
      <h6>每期打擂榜排名規則：</h6>
