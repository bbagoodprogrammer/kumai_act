<template>
  <div class="rankGroups">
    ...
    <ul v-else-if="nowTab ==2" class="stage2List">
      <li v-for="(item,index) in rank.list" :key="index" :class="[{min:item.empty},'rank'+item.rank]" @click="goPeople(item.uid)">
      ...
      <li v-for="(item,index) in rank.list" :key="index" :class="'rank'+item.rank" @click="goPeople(item.uid)">
        <div class="grouplist">
          ...
          <div class="groupScore">
            <div class="score"><i></i><em>999</em></div>
            <div class="groupT">前9名可晋级</div>
          </div>
        </div>
    ...
    <div class="stage4List" v-else>
      <div class="listTop">
        ...
        <div class="userList">
          <div class="userItem" v-for="(item,index) in lastlistTop" :key="index" :class="'item'+item.rank" @click="goPeople(item.uid)">
            <div class="imgBox">
      ...
      <ul class="lastList">
        <li v-for="(item,index) in lastlist" :key="index" :class="'rank'+item.rank" @click="goPeople(item.uid)">
          <div class="imgBox">
            <span class="avBg" v-if="item.rank <=3"></span>
            <img v-else-if="item.frame &&item.frame != ''" :src="item.frame" class="frame">
            <img v-lazy="item.avatar" alt="">
    ...
    <div class="listTips" v-if="nowTab != 4">
      <div v-if="rank.loading" class="scrollLoading">加載中...</div>
...
import getString from '../../../../AAA2020越南活动/mainVenue/src/utils/getString';
