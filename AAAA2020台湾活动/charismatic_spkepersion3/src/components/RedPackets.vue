<template>
  <div class="redPactets">
    ...
    <div class="lastOpenPacketPeople">
      <div class="title"> <span v-if="naming.uid" @click="peopleType = 1" :class="{act:peopleType == 2}">上一輪紅包由以下歌友冠名贊助</span> <span @click="peopleType = 2" :class="{act:peopleType == 1}">我的贊助</span>
      </div>
      ...
      <div class="my_vote" v-else>
        <div class="tips">我贊助的紅包數：{{rate.num}} <span v-if="rate.rank">我的排名:{{rate.rank}}</span> <span>加成:{{rate.rate}}%</span></div>
        <div class="liner">
