  ...
  <div class="rule">
    ...
    <div class="ruleItem" v-if="type==1">
      ...
      <p class="red">4、用戶報名活動成功後，分數開始計入用戶榜，本期活動成績只能計入用戶榜
        <br /> （PS：活動期間申請簽約成功，依舊享受原有的分成，只是不參加本期活動的創作者榜和房主榜的排名）
      </p>
      <h6>排行規則</h6>
      ...
      <p>6、本活動作品特定禮物為蝶花香水瓶（10金幣）、女王啟航號（129金幣）；K房特定禮物為蝶花包包（10金幣）、女王皇冠（129金幣）</p>
    ...
    <div class="wardItem" v-else>
      ...
      <h5>創作者榜獎勵</h5>
      <h6>日榜前3獎勵</h6>
      <p> 分別獎勵榜單金幣3%/2.5%/2%歡鑽分成（以每日結算時間為準）</p>
      <h6>總榜前10獎勵</h6>
      <p>第1名：</p>
      <p>總榜金幣5%歡鑽分成 + 女王頭飾（30天）+ 明星創作者徽章（30天）+ 白玉仙舟座駕（30天）+ 6000金豆 + 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <p>第2名：</p>
      <p>總榜金幣4%歡鑽分成 + 女王頭飾（20天）+ 明星創作者徽章（30天）+ 白玉仙舟座駕（30天）+ 5000金豆 + 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <p>第3名： </p>
      <p>總榜金幣3%歡鑽分成 + 女王頭飾（15天）+ 明星創作者徽章（30天）+ 白玉仙舟座駕（30天）+ 4000金豆 +網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <p>第4-10名：</p>
      <p>總榜金幣2%歡鑽分成 + 女王頭飾（7天）+ 白玉仙舟座駕（15天）+ 2000金豆 + 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <h5>房主榜獎勵</h5>
      <h6>日榜前3獎勵</h6>
      <p>分別獎勵榜單金幣2%/1.5%/1%歡鑽分成（以每日結算時間為準）</p>
      <h6>總榜前10獎勵</h6>
      <p>第1名：</p>
      <p>總榜金幣4%歡鑽分成 + 女王頭飾（30天）+ 明星房主徽章（30天）+ 明星K房標籤（14天）+ 白玉仙舟座駕（30天）+ 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <p>第2名：</p>
      <p>總榜金幣3%歡鑽分成 + 女王頭飾（20天）+ 明星房主徽章（30天）+ 明星K房標籤（10天）+ 白玉仙舟座駕（30天）+ 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <p>第3名： </p>
      <p>總榜金幣2%歡鑽分成 + 女王頭飾（15天）+ 明星房主徽章（30天）+ 明星K房標籤（7天）+ 白玉仙舟座駕（30天）+ 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <p>第4-10名：</p>
      <p>總榜金幣1%歡鑽分成+ 女王頭飾（7天）+ 明星K房標籤（3天）+ 白玉仙舟座駕（15天）+ 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <h5>用戶榜獎勵</h5>
      <h6>日榜前3獎勵</h6>
      <p>分別獎勵榜單金幣8%/5%/3%金幣分成（以每日結算時間為準）</p>
      <h6>總榜前10獎勵</h6>
      <p>第1名：</p>
      <p>禮物之王徽章（30天） + 白玉仙舟座駕（30天）+ 夢幻公主車背包禮物（888金幣）*2 + 3000金幣 + 6000金豆</p>
      <p>第2名：</p>
      <p>禮物之王徽章（30天）+ 白玉仙舟座駕（30天）+ 時尚高跟鞋背包禮物（688金幣）*2 + 2500金幣 +5000金豆</p>
      <p>第3名： </p>
      <p>禮物之王徽章（30天）+ 白玉仙舟座駕（30天）+ 冰雪王國背包禮物（499金幣）*2 + 2000金幣 + 4000金豆</p>
      <p>第4-10名：</p>
      <p>禮物之王徽章（30天）+ 白玉仙舟座駕 （15天）+ 1000金幣 + 2000金豆</p>
      <h5>榜單守護獎勵</h5>
      <p>創作者總榜和用戶總榜的第一名、第二名、第三名的貢獻第一用戶分別獎勵：守護之王徽章（30天）+ 10000金豆</p>
      <p class="mt">PS:</p>
      <p>1.榜單日榜和總榜獎勵將在活動結束的7天內發放</p>
      <p>2.獎勵的背包禮物有效期均為14天</p>
      <!-- <p>3.本活動獲得的總榜及日榜歡鑽分成將兌換由官方運營卡布奇諾（UID：1577281）負責聯繫發放</p> -->
      <p class="lastTips">該活動最終解釋權由活動主辦方所有</p>
    </div>
  </div>
</template>
