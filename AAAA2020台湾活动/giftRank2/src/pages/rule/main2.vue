<template>
  <div class="rule">
    ...
    <div class="ruleItem" v-if="type==1">
      <h5>活動規則</h5>
      <h6>報名規則</h6>
      <p>1.簽約者默認參與簽約者榜和簽約房間榜倆個榜單，若無自己創建的房間，則不參與簽約房間榜</p>
      <p>2.非簽約用戶可點擊報名參與用戶榜排名</p>
      <p>3.用戶報名活動成功后，分數開始計入用戶榜，本期活動成績只能計入用戶榜<br /> （PS：活動期間申請簽約成功，依舊享受原有的分成，只是不參加本期活動的簽約者榜和簽約房間榜的排名）
      </p>
      <h6>排行規則</h6>
      <p>1.簽約者榜、簽約房間榜和用戶榜均分為日榜與總榜</p>
      <p>2.簽約者榜按照簽約者收到的作品和K房特定禮物金幣數排名</p>
      <p>3.簽約房間榜按照簽約者的房間收到的K房特定禮物的金幣數排名</p>
      <p>4.用戶者榜按照用戶報名后收到的作品和K房特定禮物金幣數排名</p>
      <p>5.日榜和總榜均展示前100名，先達到該成績的排名在前面</p>
      <p>6.本活動作品特定禮物為桔梗花（10金幣）、螢火楓燈（129金幣）；K房特定禮物為可愛橘子（10金幣）、時尚絲巾（129金幣）</p>
    ...
    <div class="wardItem" v-else>
      ...
      <p class="mt">PS:</p>
      <p>1、榜單日榜和總榜獎勵將在活動結束的工作日7天內發放</p>
