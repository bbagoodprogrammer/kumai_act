  ...
  <div class="lastRank">
    ...
    <div class="list">
      <div class="listItem" v-for="(item,index) in list" :key="index">
        <div class="listTitle">
          <span v-if="index === 'creator'">創作者榜</span>
          <span v-else-if="index === 'room'">房主榜</span>
          <span v-else>用戶榜</span>
        </div>
        <ul>
    ...
    <div class="mask" v-show="showPeopleList">
      <transition name="slide">
        <div class="peopleList" v-if="showPeopleList">
          ...
          <p class="nodata" v-if="peopleArr.length == 0">暫無數據！</p>
          <ul>
