          ...
          <div class="goVipHtml" v-show="showGoVip">
            ...
            <div class="table">
              <ul>
                ...
                <li>
                  <span class="bor">一 {{lang.timeTips}}</span>
                  <span>2</span>
                </li>
                <li>
                  <span class="bor">三 {{lang.timeTips}}</span>
                  <span>6</span>
                </li>
                <li>
                  <span class="bor">六 {{lang.timeTips}}</span>
                  <span>14</span>
                </li>
                <li>
                  <span class="bor">一 {{lang.year}}</span>
                  <span>30</span>
                </li>
              </ul>
            </div>
...
export default {
  ...
  methods: {
    ...
    goHtml() {
      ...
      location.href = `http://act.17sing.tw/html/member_new/index.html?token=${token}&uid=${uid}&v=2`
    }
  }
}
</script>
