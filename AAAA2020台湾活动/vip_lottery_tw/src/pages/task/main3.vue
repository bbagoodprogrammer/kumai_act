...
export default {
  ...
  computed: {
    shareLink() {
      return `http://activity.17sing.tw/static_html/2020/vip_lottery/index.html?code=${this.code}`
    }
  },
  methods: {
    getGift(id, index) {
    ...
    share(code) {
      ...
      var data = {
        ...
        "link": `http://activity.17sing.tw/static_html/2020/vip_lottery/index.html?uid=${uid}&code=${code}&v=2`,
        "image": "http://activity.17sing.tw/static_html/2020/vip_lottery/share2.jpg",
        "share_url": `http://activity.17sing.tw/static_html/2020/vip_lottery/index.html?uid=${uid}&code=${code}&v=2`
      }
      if (ios) {
        this.code = code
        this.showShare = true
