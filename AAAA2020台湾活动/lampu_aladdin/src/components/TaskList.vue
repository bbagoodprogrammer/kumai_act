<template>
  <div class="taskList">
    <div class="rankListCon">
      <div class="rankTitle">
        <span class="day">任務列表</span>
        <span class="point">召喚值 </span>
        ...
        <li v-for="(item,index) in daily_tasks" :key="index">
          ...
          <span class="du">
            <span class="state">
              ...
              <span v-show="item.schule == item.limit" class="suc">已達成 </span>
            </span>
          </span>
        </li>
      </ul>
    ...
    <div class="stored">
      ...
      <div class="storedMsg">
        <div class="title">儲值任務</div>
        <div class="tips">每儲值30金幣即可獲得10召喚值 </br>今日您已儲值 {{charge}}金幣</div>
      </div>
      <div class="storeBtn" @click="goStore()">前去儲值</div>
    </div>
  </div>
</template>
<script>
