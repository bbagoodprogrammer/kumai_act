<template>
  <div class="rule">
    ...
    <div class="ruleItem" v-if="type==1">
      ...
      <p>6、本活動作品特定禮物為羽扇（10金幣）、公主裙（129金幣）；K房特定禮物為高貴面具（10金幣）、舞會高跟鞋（129金幣）</p>
    ...
    <div class="wardItem" v-else>
      ...
      <p>如當日第一名榜單金幣為1000，則獲得1000*3%*100=3000歡鑽</p>
      <h6>總榜前10獎勵</h6>
      <p>第1名：</p>
      <p>總榜金幣5%歡鑽分成 + 明星創作者徽章（30天）+ 白玉仙舟座駕（30天）+ 6000金豆 + 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <p>第2名：</p>
      <p>總榜金幣4%歡鑽分成 + 明星創作者徽章（30天）+ 白玉仙舟座駕（30天）+ 5000金豆 + 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <p>第3名： </p>
      <p>總榜金幣3%歡鑽分成 + 明星創作者徽章（30天）+ 白玉仙舟座駕（30天）+ 4000金豆 +網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <p>第4-10名：</p>
      <p>總榜金幣2%歡鑽分成 + 白玉仙舟座駕（15天）+ 2000金豆 + 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <h5>房主榜獎勵</h5>
      <h6>日榜前3獎勵</h6>
      <p>分別獎勵榜單金幣2%/1.5%/1%歡鑽分成（以每日結算時間為準）</p>
      <p>如當日第一名榜單金幣為1000，則獲得1000*2%*100=2000歡鑽</p>
      <h6>總榜前10獎勵</h6>
      <p>第1名：</p>
      <p>總榜金幣4%歡鑽分成 + 明星K房標籤（14天）+ 明星房主徽章（30天）+ 白玉仙舟座駕（30天）+ 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <p>第2名：</p>
      <p>總榜金幣3%歡鑽分成 + 明星K房標籤（10天）+ 明星房主徽章（30天）+ 白玉仙舟座駕（30天）+ 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <p>第3名： </p>
      <p>總榜金幣2%歡鑽分成 + 明星K房標籤 （7天）+ 明星房主徽章（30天）+ 白玉仙舟座駕（30天）+ 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <p>第4-10名：</p>
      <p>總榜金幣1%歡鑽分成 + 明星K房標籤 （3天）+ 白玉仙舟座駕（15天）+ 網紅歡歡簽約者專屬K房金幣禮物（50金幣）*1</p>
      <h5>用戶榜獎勵</h5>
      <h6>日榜前3獎勵</h6>
