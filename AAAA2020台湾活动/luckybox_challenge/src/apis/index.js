...
function init() {
    if (!token) {
        return axios.get(`/luckybox_challenge/init.php`)
    }
    return get(`/luckybox_challenge/init.php?token=${token}`)
}

function singUp() {
    return get(`/luckybox_challenge/register.php?token=${token}`)
}

function getGift(track) {
    return get(`/luckybox_challenge/getGift.php?token=${token}&track=${track}`)
}

function getList(from, more) {
    if (more) {
        return axios.get(`/luckybox_challenge/receiveList.php?token=${token}&from=${from}`)
    }
    return get(`/luckybox_challenge/receiveList.php?token=${token}&from=${from}`)
}
