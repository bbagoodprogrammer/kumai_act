<template>
  <div class="rule">
    ...
    <div class="ruleTips" v-if="tab == 1">
      <h5>活動時間</h5>
      <p class="tm">2月22日18:00:00-3月3日21:00:00</p>
    ...
    <div class="giftItem" v-else>
      <h5 class="mb">活動時間</h5>
      <p>2月22日18:00:00-3月3日21:00:00</p>
      <h4>活動規則</h4>
      <h6>活動報名：</h6>
      ...
      <h6>紅包攻略：</h6>
      <p>
        1、在活動期間，帶有“魅力代言人大賽”標籤作品每收到100個“元宵節快樂”禮物（129金幣），會爆1次總金額888金幣的拼手氣紅包，每次爆紅包個數200個，先到先得<br />
