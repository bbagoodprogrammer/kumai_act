<template>
  <div class="rule">
    ...
    <div class="ruleTips" v-if="tab == 1">
      <h5>活動時間</h5>
      <p class="tm">1月22日18:00:00-1月31日21:00:00</p>
      ...
      <p>PS.魅力日榜前100名用戶中的隨機20位，可獲得2個美味湯圓（20金幣）禮物。將於每天晚上12點抽出中獎名單，比賽最後一天將在比賽結束時抽出，中獎背包禮物將自動發放到賬戶上</p>
      <h5>禮物冠名獎勵</h5>
      <p>活動過程中，冠名贊助紅包次數排名第一的用戶，可獲得“元宵節快樂”禮物30天冠名獎勵，如果次數相同，先達到的排名在前面</p>
      <h5>魅力榜總榜前10名獎勵</h5>
      <p>第一名：<br />歡歌元宵魅力代言人認證（30天）+魅力代言人大禮包獎勵（首頁加魅力代言人歌曲標籤歌曲推薦1首+2000金幣）+4位靚號獎勵+元宵魅力代言人徽章（30天）+雙魚座頭飾（30天）+年獸座駕（30天）+會員VIP（30天）+元宵節快樂背包禮物（129金幣）*3+5000金幣+5000金豆 </p>
      <p>第二名：<br />元宵魅力代言人徽章（30天）+雙魚座頭飾（30天）+年獸座駕（30天）+會員VIP（30天）+元宵節快樂背包禮物（129金幣）*2+3000金幣+3000金豆</p>
      <p>第三名：<br />元宵魅力代言人徽章（30天）+雙魚座頭飾（30天）+年獸座駕（30天）+會員VIP（30天）+元宵節快樂背包禮物（129金幣）*2+2000金幣+1000金豆</p>
      <p>第四-五名：<br />元宵魅力代言人徽章（30天）+年獸座駕（30天）+會員VIP（30天）+元宵節快樂背包禮物（129金幣）*1+1500金幣+1500金豆</p>
      <p>第六-十名：<br />年獸座駕（30天）+會員VIP（30天）+元宵節快樂背包禮物（129金幣）*1+1500金幣+1500金豆</p>
    ...
    <div class="giftItem" v-else>
      <h5 class="mb">活動時間</h5>
      <p>1月22日18:00:00-1月31日21:00:00</p>
      <h4>活動規則</h4>
      <h6>活動報名：</h6>
      ...
      <p>
        ...
        3、魅力日榜前100名用戶中的隨機20位，可獲得美味湯圓禮物（20金幣）*2<br />
        4、中獎概率=本人日榜星光值/前100名用戶當天日榜總星光值
      </p>
      <h6>等級抽獎攻略：</h6>
      <p>
        1、老虎機共有4個，星光值達到分別達到100、1500、4000、8000，可抽取對應的老虎機獎勵，每次抽獎將得到3樣獎品。領取後獎勵將自動到賬，每人僅可抽取同一個老虎機獎勵1次<br />
        2、第7次進行Lv.4等級抽獎，必中徽章獎勵3、所有老虎機抽獎有效期為活動結束前，請及時抽獎唷~<br />
        3、所有老虎機抽獎有效期為活動結束前，請及時抽獎唷~
      </p>
      <h6>紅包攻略：</h6>
      <p>
        1、在活動期間，帶有“魅力代言人大賽”標籤作品每收到100個“元宵節樂”禮物（129金幣），會爆1次總金額888金幣的拼手氣紅包，每次爆紅包個數200個，先到先得<br />
