  ...
  <div class="box">
    ...
    <div class="header">
      <div class="tipsBox" :class="{top:isShare}">
        <span class="ruleTips" @click="goRule()">规则&獎勵</span>
        <span class="histyry" @click="goRule()">往期名人堂</span>
      </div>
    ...
    getDefaultData(val) { //初始化
      api.getDefault().then(res => {
        ...
        if (response_status.code == 0) {
          ...
          this.vxc('setNowDay', nowTime.nowDay)
          this.vxc("changTab", nowTime.nowDay)
...
.box {
  ...
  position: relative;
  margin: auto;
  background: #ef739c url(../assets/img/banner.png) center 0 no-repeat;
