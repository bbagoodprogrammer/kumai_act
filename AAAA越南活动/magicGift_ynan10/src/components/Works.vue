<template>
  <div class="words" :class="{active:activateState === 0}">
    <div class="wardsSample">
      <p class="rankTips"> Xếp hạng theo mị lực quà mà bài hát nhận từ những quà sau </p>
      <div class="wards">
        <!-- <img src="../assets/img/ward1.png" alt="">
        <div class="giftName">
          <span>Kem Ốc Quế</span>
          <span>Súng Nước</span>
          <span>Xe Bán Kem</span>
        </div> -->
        <div class="wardItem">
          <img src="../assets/img/ward1.png" alt="">
          <strong>Chong Chóng Tre</strong>
        </div>
        <div class="wardItem">
          <img src="../assets/img/ward2.png" alt="">
          <strong>Đô Rê Mon</strong>
        </div>
        <div class="wardItem">
          <img src="../assets/img/ward3.png" alt="">
          <strong>Bốt Điện Thoại</strong>
        </div>
      </div>
      <p class="fansong">Tặng quà trên cho bài hát dự thi, người tặng sẽ nhận lại 5% số xu vào sáng sớm hôm sau</p>
    </div>
