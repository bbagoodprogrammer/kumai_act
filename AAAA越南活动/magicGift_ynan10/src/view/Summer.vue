<template>
  <div class="bigBox">
    <div class="header">
      <a href="./index2.html" :class="{shareTop:isShare}"></a>
    </div>
    ...
    <div class="footer" v-if="!isShare">
      <a class="singUp" v-if="showFooter === 2" @click.prevent="singUp()">Báo danh</a>
      <span v-if="showFooter === 0" class="noAct">Sự kiện chưa bắt đầu</span>
      <span v-if="showFooter === 1" class="noAct">Sự kiện đã kết thúc</span>
...
body {
  ...
  position: relative;
  margin: auto;
  background: rgba(54, 29, 163, 1) url(../assets/img/bigBg.png) no-repeat;
