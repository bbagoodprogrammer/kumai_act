<template>
  <div class="words" :class="{active:activateState === 0}">
    <div class="wardsSample">
      <p class="rankTips"> <strong>Xếp hạng theo mị lực quà mà bài hát nhận từ những quà sau</strong> </p>
      <div class="wards">
        <div class="wardItem">
          <img src="../assets/img/ward1.png" alt="">
          <strong>Kẹo Cầu Vồng</strong>
        </div>
        <div class="wardItem">
          <img src="../assets/img/ward2.png" alt="">
          <strong>Phấn Trang Điểm</strong>
        </div>
        <div class="wardItem">
          <img src="../assets/img/ward3.png" alt="">
          <strong>Hộp Trang Sức</strong>
        </div>
      </div>
      <p class="fansong">Tặng quà cho bài hát dự thi, người tặng sẽ nhận lại 5% số xu vào sáng sớm hôm sau</p>
    </div>
