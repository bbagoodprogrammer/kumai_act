    ...
    <div class="wardsSample">
      ...
      <div class="wards">
        <div class="wardItem">
          ...
          <strong>Đốt Pháo</strong>
        </div>
        <div class="wardItem">
          <img src="../assets/img/ward2.png" alt="">
          <strong>Lì Xì Tết</strong>
        </div>
        <div class="wardItem">
          <img src="../assets/img/ward3.png" alt="">
          <strong>Dư Dả Cả Năm</strong>
        </div>
      </div>
      <p class="fansong">Tặng quà cho bài hát dự thi, </br>người tặng sẽ nhận lại 5% số xu vào sáng sớm hôm sau</p>
    </div>
