    ...
    <div class="wardsSample">
      ...
      <div class="wards">
        ...
        <div class="wardItem">
          ...
          <strong>Múa Lân</strong>
        </div>
      </div>
      <p class="fansong">Tặng quà cho thí sinh dự thi tại phòng Kara,</br>người tặng sẽ nhận lại 5% số xu vào sáng sớm </p>
    </div>
