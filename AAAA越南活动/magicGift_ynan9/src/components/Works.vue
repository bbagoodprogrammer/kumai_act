  ...
  <div class="words" :class="{active:activateState === 0}">
    <div class="wardsSample">
      ...
      <div class="wards">
        ...
        <!-- <div class="wardItem">
          <img src="../assets/img/ward1.png" alt="">
          <strong>Bình Nước</strong>
        </div>
        <div class="wardItem">
          <img src="../assets/img/ward2.png" alt="">
          <strong>Ngựa Gỗ</strong>
        </div>
        <div class="wardItem">
          <img src="../assets/img/ward3.png" alt="">
          <strong>Ôtô Đồ Chơi</strong>
        </div> -->
      </div>
      <p class="fansong">Tặng quà cho bài hát dự thi, người tặng sẽ nhận lại 5%<br>
        số xu vào sáng sớm hôm sau</p>
    </div>
