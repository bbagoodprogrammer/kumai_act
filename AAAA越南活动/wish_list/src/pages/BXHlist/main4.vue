<template>
  <div class="BXHlist">
    <div class="tabs">
      <span class="tab1" @click="changTab('tab1')" :class="{actTab:showTab == 'tab1'}">BXH Tặng</span>
      <span class="tab2" @click="changTab('tab2')" :class="{actTab:showTab == 'tab2'}">BXH Hoàn Thành</span>
    </div>
    <p class="tips1">
      BXH này chỉ hiện top 100 người hoàn thành</br>
      nhiều Điều Ước nhất!
    </p>
    <p class="tips2" v-show="showTab == 'tab1'">
      Điểm Điều Ước = số bài hát đã tặng + số  điểm hài lòng do chủ nhân điều ước đánh giá
    </p>
    <p class="tips2" v-show="showTab == 'tab2'">
      Điểm Điều Ước=số bài hát hoàn thành Điều Ước được tặng
    </p>
    ...
    <div class="footer">
      <div class="box">
        ...
        <div class="score" v-else-if="showTab == 'tab1'">
          Tặng: <em>{{userMsg.score}}</em><i></i>
        </div>
        <div class="score" v-else>
          Nhận: <em>{{userMsg2.score}}</em>
        </div>
      </div>
    </div>
  </div>
