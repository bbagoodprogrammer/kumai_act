<template>
  <div class="rankGroups">
    ...
    <div v-if="rank.list.length == 0" class="scrollNone">Tạm chưa có số liệu!</div>
    ...
    <transition name="slide">
      <div class="userItemPup mask" v-show="showUser">
        <div class="userCon" :class="{maxHigt:showPup3}">
          ...
          <p class="jiyuTitle">——<i>·</i> Lời nhắn <i>·</i> ——</p>
          ...
          <p class="Tips" v-if="showPup3">Sau khi lấy Điều Ước, đăng bài hát công khai đầu tiên sẽ được gửi tặng chủ nhân của Điều Ước
            <span>Sau khi lấy Điều Ước, đăng bài hát công khai đầu tiên sẽ được gửi tặng chủ nhân của Điều Ước</span>
            <span class="red">Hãy gửi bài điều ước trong 24 tiếng sau khi hái về, nếu không điều ước sẽ trở về trạng thái đợi hái</span>
    ...
    <transition name="slide">
      <div class="pup2 mask" v-show="showPup2">
        <div class="pup2Con">
          ...
          <p class="title">Xác nhận từ bỏ Điều Ước?</p>
          <p class="msg">
            Lấy Điều Ước này sẽ bỏ Điều Ước trước đây?
            Xác nhận từ bỏ Điều Ước trước đây và lấy Điều Ước này?
          </p>
          <div class="btnBox">
      ...
      globalBus.$emit('commonEvent', () => {
        api.zhaiqu(id).then((res) => {
          if (res.data.response_status.code === 0) {
            ...
            this.tastMsg = `Đã có người nhận lấy điều ước này trước khi bạn lấy!`
            this.showT = true
          } else if (res.data.response_status.code === 60001) {
            this.tastMsg = `Trong thời gian sự kiện bài hát bị chấm 1 điểm đạt 10 lần hoặc xoá bài hát đạt 5 lần sẽ không thể hái điều ước của người khác.`
            this.showT = true
