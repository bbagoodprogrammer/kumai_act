<template>
  <div class="history1">
    <p v-if="history1.list && history1.list.length == 0" class="tips">Tạm chưa có số liệu</p>
    <ul class="scrollable" v-else>
      <li v-for="(item,index) in history1.list" :key="index">
        ...
        <p class="tips">Bài hát hoàn thành Điều Ước của bạn</p>
        <div class="auido">
        ...
        <div class="score">
          <p class="scoreTitle">Đánh giá độ hài lòng</p>
          <div class="scoreBox">
      ...
      <p v-show="loading" class="loadingTips">Đang tải...</p>
    </ul>
