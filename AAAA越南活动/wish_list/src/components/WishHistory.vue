  ...
  <div class="wishHistory">
    <div class="historyCon">
      ...
      <div class="userMsg">
        ...
        <div class="finished">Điều Ước hoàn thành：{{history1.finished}}</div>
        <div class="sent">Điều Ước đã gửi：{{history1.sent}}</div>
      </div>
      <div class="tabs">
...
export default {
  ...
  methods: {
    ...
    setAudio(path, songId) {
      if(path == ''){
        this.showT = true
        this.tastMsg = 'Bài hát ước nguyện này đã bị xoá!'
        return
      }
