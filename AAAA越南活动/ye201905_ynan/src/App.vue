...
export default {
  ...
  data() {
    return {
      ...
      showT: false,
      imgArr: [
        require('./assets/img/carItemBg.png'),
        require('./assets/img/familyCard.png'),
        require('./assets/img/pupBg1.png'),
        require('./assets/img/pupBg2.png')
      ]
    }
  },
  created() {
    globalBus.$on('commonEvent', (callback) => {
      if (this.isShare) {
        ...
        this.tastMsg = lang.actState1
        this.showT = true
      } else if (this.actStatus === 2) {
        this.tastMsg = lang.actState2
        this.showT = true
      } else {
        callback()
      }
