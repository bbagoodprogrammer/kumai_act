  ...
  <div class="box">
    ...
    <div class="header">
      <div class="tipsBox" :class="{top:isShare}">
        ...
        <span class="mian" @click="goMain()"></span>
        <span class="getTicket" @click="getTicket()"></span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    goMain() {
      ...
      location.href = `http://activity.singnowapp.com/static_html/2019/mainVenue/index.html?uid=${uid}&token=${regstr}`
    },
    getTicket() {
      let regstr = getString('token')
      let uid = getString("uid")
      location.href = `http://activity.singnowapp.com/static_html/2019/numberOnePlayer/index.html?uid=${uid}&token=${regstr}&t=2`
    },
    refrsh() { //刷新
