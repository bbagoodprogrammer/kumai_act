<template>
  <div class="rankGroups">
    ...
    <div class="downTimebox" v-if="totalShowTotalTime && mainTab == 1">
      <p><em class="timeLf"></em>Sự kiện kết thúc còn<em class="timeRi"></em></p>
      <div class="timeDown">
        <div class="day">
    ...
    <div v-if="rank.none || (rank.list.length == 0 && (tab == nowDay || tab ==='total'))" class="scrollNone">Danh sách trống!</div>
    <div v-if="mainTab==0 && tab > nowDay" class="dengdai">Vui lòng đợi</div>
  </div>
</template>
