  ...
  <div class="box">
    ...
    <div class="header">
      ...
      <div class="ruleBox" :class="{top:isShare}">
        <span class="ruleTips" @click="goRule()">Thưởng&Thể lệ</span>
        <span class="history" @click="goHistory()">Lịch sử nhận></span>
      </div>
    </div>
    <integral></integral>
    ...
    <transition name="slide">
      <div class="firstPup" v-if="showFirstGift">
        <div class="firstCon">
          <div class="title"></div>
          <div class="getIntegral" @click="doTask()">Nhận điểm>></div>
          <div class="giftItem">
            <span class="close" @click="closeFirstPup()"></span>
            <div class="giftOne">
              <span>Điểm đạt 70</span>
              <div class="imgBox">
                <img src="../assets/img/PupImg/ward0.png" alt="">
              </div>
              <em>{{gift_list.gift_list[0].counts}}đậu</em>
            </div>
            <div class="giftOne">
              <span>Điểm đạt 90</span>
              <div class="imgBox">
            ...
            <div class="giftOne">
              <span>Điểm đạt 150</span>
              <div class="imgBox">
                <img src="../assets/img/PupImg/ward3.png" alt="">
              </div>
              <em>Ngẫu nhiên gấp đôi 1 món trong 3 mục quà trước</em>
            </div>
          </div>
        </div>
      </div>
    ...
    getDefaultData(val) { //初始化
      api.getDefault(0).then((res) => {
        ...
        if (response_status.code == 20000) { //活動未開始
          ...
          this.$store.commit("changIntegral", owner_msg.daily_star)  //當前積分
  ...
  .header {
    ...
    .snowBg {
      ...
      .snow {
        ...
        // height: 6.28rem;
        // position: absolute;
        // background: url(../assets/img/snowBg.png);
        // background-size: 100% 100%;
