<template>
  <div class="history">
    <div class="title">Thời gian nhận thưởng</div>
    <div class="giftlist">
      <div class="listTitle">
        <span class="time">Thời gian</span>
        <span class="gift">Nhận thưởng</span>
      </div>
      <ul class="scrollable">
      ...
      <p v-if="record.length == 0" class="noDate">Chưa có lịch sử nhận quà</p>
    </div>
    <Loading></Loading>
  </div>
</template>
