...
export default {
  data() {
    return {
      rankName: {
        login: "- Vào trang sự kiện",
        publicWork: "- Đăng 1 bài hát công khai",
        last_publicWork: "- Không xoá bài hát đăng hôm trước",
        praise: "- Nhấn Thích 10 bài hát",
        share: "- Chia sẻ bài hát sang app khác",
        online: "- Vào phòng Kara 15 phút",
        kmic_start: "- Lên mic tại phòng Kara 1 lần",
        radio_online: "- Vào phòng Radio 15 phút",
        sendBean: "- Tặng 100 đậu trở lên",
        sendCoin: "- Tặng xu trong ngày đạt ",
        charge: "-  Nạp xu trong ngày đạt",
      },
      wholePup: false,
      nowTask_list: [],
      finish_count: 0
  ...
  methods: {
    ...
    share() {
      globalBus.$emit('commonEvent', callback => {
        ...
        var data = {
          "share_title": "Hay quá! Tôi đang đập chuột quay thưởng đổi vé bầu.",
          "share_content": "Mau đến giúp tôi kiếm cắc nào!",
          "share_image": "http://activity.singnowapp.com/static_html/2019/numberOnePlayer/share.png",
          "link": `http://activity.singnowapp.com/static_html/2019/numberOnePlayer/index.html?uid=${this.groupsUserMsg[2].msg.uid}`,
          "image": "http://activity.singnowapp.com/static_html/2019/numberOnePlayer/share.png",
        }
        if (ios) {
          // if (window.share != undefined) {
          //   share(JSON.stringify(data))
          // } else {
          location.href = 'shareUserInfo://http://activity.singnowapp.com/static_html/2019/numberOnePlayer/index.html&shareText=Mau đến giúp tôi kiếm cắc nào! &userImg=http://activity.singnowapp.com/static_html/2019/numberOnePlayer/share.png&title=Hay quá! Tôi đang đập chuột quay thưởng đổi vé bầu.';
          // }
        } else {
          if (getAppUaInfo(ua).ver >= 670682) {
            javascript: JSInterface.share(JSON.stringify(data));
          } else {
            javascript: JSInterface.share('http://activity.singnowapp.com/static_html/2019/numberOnePlayer/index.html?uid=' + this.groupsUserMsg[2].msg.uid + '', 'Hay quá! Tôi đang đập chuột quay thưởng đổi vé bầu.', 'Mau đến giúp tôi kiếm cắc nào!', 'http://activity.singnowapp.com/static_html/2019/numberOnePlayer/share.png');
          }
        }
      })
    }
