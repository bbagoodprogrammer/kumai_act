<template>
  <div class="box">
    <div class="tipsBox">
      ...
      <span class="ruleTips history" :class="{top:isShare}" @click="history()">Lịch sử</span>
    </div>
    <RoolMsg />
    <Game />
    <TabsScrollLoadList />
    ...
    <div class="mask" v-show="invitation">
      <transition name="slide">
        <div class="invitationPup" v-if="invitation">
          ...
          <p>Bạn bè mời bạn tham gia sự kiện Phú ông</p>
          <ul>
          ...
          <p class="tips">Thành công mời bạn tham gia sự kiện, có cơ hội nhận <i></i>*3</p>
          <span class="singUpBtn" @click="singUp()">chấp nhận lời mời</span>
        </div>
      </transition>
    </div>
