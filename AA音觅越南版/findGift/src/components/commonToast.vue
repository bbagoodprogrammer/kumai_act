    ...
    <transition name="slide">
      <div class="promptBox" v-show="toast">
        ...
        <div class="btnBox" v-if="totasType!=1">
          <span class="red" @click="close()">Hủy</span>
          <span class="ok" v-if="totasType==2" @click="query()">OK</span>
          <span class="ok" v-else-if="totasType==3" @click="query()">Ấn mua</span>
          <span class="ok" v-else @click="query()">Ấn nhận</span>
        </div>
