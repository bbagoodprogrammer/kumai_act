<template>
  <div class="box">
    ...
    <div class="header">
      ...
      <Lottie />
      <bar />
      <p class="barTipsMsg"> <i></i> Nhấn vào hưu sao xem qua tăng cấp</p>
    </div>
    <LandBox />
    <rank ref="rank" />
    <!-- 规则 -->
    ...
    <div class="mask" v-show="getDeer">
      <transition name="slide">
        <div class="getDeerPup" v-show="getDeer">
          ...
          <div class="title"></div>
          <p class="firstTips">Mỗi ngày nhận bình nước trồng thức ăn, nuôi hưu sao， </br>nhận huy hiệu, quà có hạn</p>
          <div class="giftBox">
      ...
      firstGiftArr: [
        {
          ...
          msg: 'Hưu hoang dã (quà túi)'
        },
        {
          img: require('../assets/img/firstDeer3.png'),
          msg: 'Hưu hoa đào (quà túi)'
        },
        {
          img: require('../assets/img/firstCar.png'),
          msg: 'Gặp hưu rừng sâu (quà hiệu ứng)'
        }
      ],
      ...
      globalBus.$emit('commonEvent', () => {
        api.singUp(uid).then(res => {
          ...
          if (response_status.code == 0) {
            ...
            this.vxc('setLandInfo', land_infos)
            this.vxc('setToast', {
              msg: `Nhận bình nước, trồng thức ăn cho hưu con!`,
