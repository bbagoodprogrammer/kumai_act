<template>
  <div class="barBox">
    <div class="barTips">Trưởng thành</div>
    <div class="bar">
  ...
  data () {
    return {
      ...
      tipsArr: [
        {},
        {
          tips: 'Sẽ nuôi được hưu siêu đẹp',
          gift: [
            {
              img: 'deer2',
              msg: 'Hưu siêu đẹp </br> <i>x3</i>'
            },
            // {
            //   img: 'coins1',
            //   msg: '30金幣'
        ...
        {
          tips: 'Sẽ nuôi được hưu hoang dã',
          gift: [
            {
              img: 'deer3',
              msg: 'Hưu hoa đào </br> <i>x3</i>'
