  ...
  <div class="lanCon">
    ...
    <div class="functionBtn">
      <div class="getWater" :class="{black:!userMsg.registered}" @click="showTasks()">
        <strong>Bình nước: {{userMsg.water_count}}</strong>
      </div>
    ...
    <div class="mask" v-if="upgrading">
      <transition name="slide">
        <div class="surprise" v-show="upgrading">
          ...
          <div class="userLv">
            <i>LV{{userLv}}</i>
            <em>Điểm trưởng thành đạt{{lvArr[userLv - 1]}}</em>
          </div>
...
export default {
  ...
  data () {
    return {
      ...
      supriseMsg: [
        '',
        'Mỗi ngày soi gương, tôi thấy mình ngày càng đẹp hơn',
        'Tôi chỉ muốn được hẹn hò, chẳng phải làm chủ thế giới... mà sao khó thế',
        'Cùng một bài hát, nhưng tôi có thể hát theo kiểu dân ca, nhạc trẻ và cả nhạc rap.',
        'Tôi tự kỷ cấp 6, tâm sự cấp 8, 9 lần vô địch cú đêm, quá dữ!'
      ],
      first: true,
      showDayTasks: false,
      showPropList: false,
  ...
  methods: {
    ...
    share () {
      ...
      share({
        ...
        url: `http://activities.alochatapp.com/static_html/2020/deerMan/index.html?type=2&t=${t}`,
        title: 'Tôi đang nuôi hưu sao, rất vui,Tặng bạn 1 hưu con nhé!',
        desc: 'Tôi đang nuôi hưu sao, rất vui,Tặng bạn 1 hưu con nhé!',
        image: 'http://activities.alochatapp.com/static_html/2020/deerMan/share.jpg'
      })
    }
  }
}
