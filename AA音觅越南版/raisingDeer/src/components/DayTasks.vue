      ...
      <li v-for="(item,index) in list" :key="index">
        <div class="taskMsg">
          <div class="name">{{item.desc}}
            <em class="invitationed" @click="showInv()" v-if="item.id == 11">Đã mời {{total_invited_users}} người>>></em>
          ...
          <div class="giftTips">Quà mỗi lần <i></i>X{{item.reward}}, mỗi ngày {{item.limit}} lần</div>
        </div>
        <div class="status">
    ...
    <div class="mask" v-show="invitationedPup">
      <transition name="slide">
        <div class="invitationedPup" v-if="invitationedPup">
          ...
          <p v-if="invList.length == 0" class="noData">Bạn nhiều, nuôi hưu nhanh hơn, kết bạn nào!</p>
          <ul class="scrollable">
    ...
    goHtml (link, rid, id) {//0無鏈接，1進房間，2邂逅頁，3儲值頁，4分享活動，5邀請好友
      ...
      if (link == 1) {
        ...
        try {
          share({
            from: '1_0',
            url: `http://activities.alochatapp.com/static_html/2020/deerMan/index.html?type=1`,
            title: 'Tôi đang nuôi hưu sao, rất vui! Tặng bạn 1 bé hưu nhé!',
            desc: 'Tôi đang nuôi hưu sao, rất vui! Tặng bạn 1 bé hưu nhé!',
