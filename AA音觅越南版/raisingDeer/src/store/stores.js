...
const store = new Vuex.Store({
  state: {
    ...
    // userSore: 9999,  //用戶成長值
    // userWater: 10,   //用户水瓶数
    lvArr: [0, 2000, 10000, 20000, 40000],
    aniImg: 0,
    rank: [],
    propMissions: {}, //道具頁
    mouthAni: 1,
      ...
      let arr = [
        {
          ...
          tips: "Nhận hưu con</br>Có thể mở khóa", //解锁提示文案
        ...
        },
        {
          ...
          tips: "Nuôi hưu siêu đẹp</br>Có thể mở khóa", //解锁提示文案
          time_require: 3, //成熟所需时间
          water_require: 6, //浇水所需水瓶数
        ...
        },
        {
          ...
          ripe_time: 0, // 倒计时秒数
          unlock_level: 10000,
          tips: "Nuôi hưu hoa đào</br>Có thể mở khóa",
          time_require: 3,
          water_require: 6,
          reward_exp: 150
        },
        {
          ...
          ripe_time: 0, // 倒计时秒数
          unlock_level: 20000,
          tips: "Nuôi hưu hoang dã</br>Có thể mở khóa",
          time_require: 3,
          water_require: 6,
          reward_exp: 200
        }
