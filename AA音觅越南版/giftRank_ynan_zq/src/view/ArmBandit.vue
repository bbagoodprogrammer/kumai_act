        ...
        <div class="rule" v-if="showRules">
          <div class="con">
            ...
            <div class="giftBox">
              ...
              <p>Hạng 1: Khung ảnh-thuyền chài (10 ngày), xe -Kiệu hằng nga(7 ngày)<br />
                Hạng 2: Khung ảnh -thuyền chài (7 ngày）<br />
                Hạng 3: Khung ảnh -thuyền chài(5 ngày）
              </p>
...
.box {
  ...
  position: relative;
  margin: auto;
  background: #24195a url(../assets/img/banner.png) center 0
    no-repeat;
