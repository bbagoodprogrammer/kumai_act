...
export default {
  data() {
    return {
      taskName: {
        login: 'دخول صفحة النشاط يوميا',
        publicWork: 'نشر عمل واحد عام يوميا',
        noDel: 'العمل الذي نشرته أمس غير محذوف',
        like5: 'الإعجاب لخمسة أعمال مختلفة',
        stayKtv: 'بقاء 20 دقيقة على الأقل في غرفة الغناء غير المشفرة',
        sing: 'الغناء أكثر من دقيقة واحدة في أي غرفة الغناء غير مشفرة',
        sendBean: 'إهداء 200 فول الهدايا تراكميا يوميا',
        getGift: 'تصل قيمة الهدايا المحصلة إلى 200 عملة تراكميا يوميا',
        charge: 'يقوم بشحن 400 عملة تراكميا يوميا',
