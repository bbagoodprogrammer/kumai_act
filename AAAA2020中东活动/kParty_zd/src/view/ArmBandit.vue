      ...
      <transition name="slide">
        <div class="rules" v-if="showRule">
          ...
          <div class="type1" v-if="is_admin">
            ...
            <p>1. يمكن لصاحب الغرفة أو مدير الغرفة أن يقدم الطلب لإقامة الحفلة، انقر "تقديم الطلب لإقامة الحفلة" و املأ استمارة الطلب لإقامة الحفلة. يجب علىيك طلب النشاط قبل يومين إثنين إلى 15 يوما بداية النشاط، يجب على وقت كل النشاط أكثر من ساعة و أقل من 10 ساعات.</p>
