<template>
  <div class="rule">
    ...
    <p class="actTime">وقت النشاط:12:00 27\1 -23:00 11\2 (بتوقيت دبي)</p>
    <div class="ward" v-show="showType == 'wards'">
      ...
      <p>شارة مستدعي المصباح السحري(30 يوم)+مركبة دخول سيارة فيراري(30 يوم)+ 5 هدايا المصباح السحري في غرفة الغناء(واحد=99 عملة)+20000 عملة+5000 فول</p>
      <h6>المرتبة الثانية:</h6>
      <p>شارة مستدعي المصباح السحري(15 يوم)+مركبة دخول سيارة فيراري(30 يوم)+ 3 هدايا المصباح السحري في غرفة الغناء(واحد=99 عملة)+15000 عملة+3000 فول</p>
      <h6>المرتبة الثالثة:</h6>
      <p>شارة مستدعي المصباح السحري(7 يوم)+مركبة دخول سيارة فيراري(30 يوم)+ 3 هدايا المصباح السحري في غرفة الغناء(واحد=99 عملة)+10000 عملة+2500 فول</p>
      <h6>المرتبة الرابعة حتى الخامسة:</h6>
      <p>شارة مستدعي المصباح السحري(7 يوم)+مركبة دخول سيارة فيراري(15 يوم)+ 2 هدايا المصباح السحري في غرفة الغناء(واحد=99 عملة)+7000 عملة+2000 فول</p>
      <h6>المرتبة السادسة حتى العاشرة:</h6>
      <p>مركبة دخول سيارة فيراري(9 يوم)+1 هدية المصباح السحري في غرفة الغناء(واحد=99 عملة)+3000 عملة+1000 فول</p>
    ...
    <div class="rules" v-show="showType == 'rules'">
      ...
      <h3>وصف المهمات</h3>
      <p>1. مهمة الشحن: شحن كل 200 عملة=10 قيمة الاستدعاء</p>
