    ...
    <div class="mask" v-show="showTipsPup">
      <transition name="slide">
        <div class="boxGifts tipsPup" v-if="showTipsPup">
          ...
          <p>الهدايا المحدودة لزيادة النقاط: إذا تتلقى الأعمال المشتركة هدايا تالية: خذ قلبي(30 عملات) وmicrophone(199 عملة) وباقة الحب (850 عملة)، فستزيد قيمة السحر بنسبة %5</p>
