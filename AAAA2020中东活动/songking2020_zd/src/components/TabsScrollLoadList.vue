  ...
  <div class="rankGroups">
    ...
    <div class="rankTips">
      <div class="giftTips" v-if="mainTab == 0">
        <p>نقاط التألق=عدد الإعجاب للأعمال المشتركة*10+قيمة السحر للأعمال المشتركة <br />إذا تتلقى الأعمال المشتركة هدايا تالية، فستزيد قيمة السحر بنسبة %5</p>
        <div class="giftItem">
        ...
        <p class="timeTips">إذا تتلقى الأعمال المشتركة هدايا العملات أثناء 21:00-21:10 بتوقيت دبي كل يوم، فستزيد قيمة السحر بنسبة %10</p>
      </div>
    </div>
    ...
    <div class="rankList">
      <ul v-if="mainTab==0" class="list day">
        <li v-for="(item,index) in rank.list" :key="index" :class="'rank' +item.rank">
          ...
          <div class="msg">
            ...
            <div class="add" v-if="item.ratio > 0">زيادة {{item.ratio}}%</div>
          </div>
          <div class="score">
            <div class="lv">Lv.{{item.level}} <em class="lvScore">نقاط التألق: {{item.score}}</em> </div>
            <div class="iconScore">
      ...
      <div class="listTipsBox" v-if="rank.loading|| rank.none">
        <div v-if="rank.loading" class="scrollLoading">جاري التحميل...</div>
...
.rankGroups {
  ...
  .mainTabs {
    ...
    .tabs {
      ...
      align-items: center;
      margin: 0 auto;
      background: url(../assets/img/rank/tabs.png);
