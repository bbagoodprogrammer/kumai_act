...
export default {
  ...
  computed: {
    shareLink() {
      return `http://activity.gosingapp.com/static_html/2020/vip_lottery/index.html?code=${this.code}`
    }
  },
  methods: {
    getGift(id, index) {
    ...
    share(code) {
      ...
      var data = {
        ...
        "image": "http://activity.gosingapp.com/static_html/2020/vip_lottery/share2.jpg",
