  ...
  <div class="box">
    <div class="header">
      <div class="goBox" :class="{top:isShare}">
        ...
        <!--  v-if="userMsg.user_flag != 0" -->
        <span class="Invitation" @click="invi()">{{lang.Invitation}}</span>
      </div>
      <!-- v-if="is_allow_version" -->
    ...
    <div class="mask" v-show="showFillCode">
      <transition name="slide">
        <div class="reCode" v-show="showFillCode">
          ...
          <p class="tips" v-html="lang.main1"></p>
...
.box {
  ...
  position: relative;
  margin: auto;
  background: rgba(43, 38, 33, 1) url(../assets/img/banner.png) center 0
    no-repeat;
