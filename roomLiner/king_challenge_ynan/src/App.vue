    ...
    <div class="petsNum">
      ...
      <div class="user1" v-if="!user1.util">
        ...
        <div class="msg" v-else>
          ...
          <div class="userMsg" v-else>
            <div class="rank">{{user2.rank}} <span v-if="user2.mic">Đang hát</span></div>
      ...
      <div class="user1">
        <div class="msg">
          ...
          <div class="noSingUp" v-if="!user1.reg">Chưa báo danh sự kiện</div>
          <div class="userMsg" v-else>
            <div class="rank">{{user1.rank}}
              <span v-if="user1.task">Đã điểm danh</span>
              <span v-else class="no_s">Chưa điểm danh</span>
            </div>
      ...
      <div class="user2" v-if="user1.util">
        <span class="lastScore">Đến xếp hạng {{lvArr[user1.level]}} còn cần <span>{{user1.util}}</span> </span>
      </div>
    </div>
  </div>
</template>
