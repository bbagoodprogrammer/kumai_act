...
module.exports = {
    ...
    plugins: [
        new HtmlPlugin({
            filename: 'index.html',
            template: 'src/html/button.html',
            chunks: ['runtime', 'config', 'vendor', 'common', 'app'],
        }),
        ...
        new ScriptExtHtmlWebpackPlugin({
            ...
            inline: ['runtime'] // 由于上线后配置也少改，cacheGroups中的config不内联到html，避免一些URL配置直接暴露出来
        }),
        ...
        new CleanWebpackPlugin('button', {root:resolve('../')}),
        new VueLoaderPlugin(),
