export default {
    ...
    room_pk_tips: 'Phòng Kara đạt 10k điểm nhận Khung phòng(7 ngày).',//活動期間達到10000分的K房可獲得王者挑戰房間邊框7天
    ...
    rank_min: 'phút',//分
    rank_second: 'giây', //秒
    rank_tips1: 'Xếp hạng theo thời gian sự kiện điểm mị quà xu thí sinh nhận được dưới chế độ PK 1v1/ PK Võ Đài/ Thách đấu quà tặng/ Hát Karaoke / Hóng hớt', //根據用戶個人在禮物紅包/福運禮盒/砸蛋探寶中所花費的金幣進行排名
    rank_tips2: 'Xếp hạng theo thời gian sự kiện điểm mị xu tiêu trong phòng Kara dưới chế độ PK 1v1/ PK Võ Đài/ Thách đấu quà tặng/ Hát Karaoke / Hóng hớt', //根據房間中禮物紅包/福運禮盒產生的魅力值進行排名房間內每開啟一次火箭活動分數增加10000
