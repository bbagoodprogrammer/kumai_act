export default {
    ...
    integral_tips: ' Tiêu xu bằng nổ Lì Xì/ tặng Hộp May Mắn/ chơi Đập Trứng sẽ nhận thưởng tương ứng.',//在禮物紅包/福運禮物/砸蛋探寶中消費金幣可獲得相應獎勵
    ...
    rank_min: 'Phút',//分
    rank_second: 'Giây', //秒
    rank_tips1: ' Xếp hạng theo số xu người dùng tiêu bằng <br />nổ Lì Xì/ tặng Hộp Quà May Mắn/ chơi Đập Trứng.', //根據用戶個人在禮物紅包/福運禮盒/砸蛋探寶中所花費的金幣進行排名
    rank_tips2: '  Xếp hạng theo điểm mị từ nổ Lì Xì /tặng Hộp Quà May Mắn.<br />Trong phòng mỗi lần nổ tên lửa sẽ tăng 10000 điểm.', //根據房間中禮物紅包/福運禮盒產生的魅力值進行排名房間內每開啟一次火箭活動分數增加10000
