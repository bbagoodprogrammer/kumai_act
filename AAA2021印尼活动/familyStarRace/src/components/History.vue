<template>
  <div class="hsitoryList">
    ...
    <div class="listTitle">
      <span class="num">{{lang.history_name}}</span>
      <span class="nick">{{lang.history_nick}}</span>
      <span class="uid">{{lang.history_uid}}</span>
      <span class="gift">{{lang.history_gift}}</span>
    </div>
    <p v-if="hList.length == 0" class="noData">{{lang.noData}}</p>
    <ul class="scrollable">
