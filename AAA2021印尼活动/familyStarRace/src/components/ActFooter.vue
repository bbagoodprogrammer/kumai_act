  ...
  <div class="footerBar">
    <div class="acrStatus" :class="{noBg:astState === 3 && showType == 2 && !nowUsrMsg.pk_data}">
      ...
      <div class="actIng" :class="'rank'+nowUsrMsg.rank" v-if="astState === 3 && showType == 1">
        ...
        <div class="rank noTop" v-else>{{lang.noRank}}</div>
        <div class="uerImg">
        ...
        <div class="userMsg">
          ...
          <div class="score" v-if="nowTab != 'total'">{{nowDays}}{{lang.dayScore}}{{nowUsrMsg.score}}</div>
        </div>
        <div class="updaSong">
          <!-- <div class="btn" @click="goCommitSong()">上傳作品</div> -->
          <div class="luckTips" v-if="nowTab != 'total'">{{lang.luckPro}}{{nowUsrMsg.pro}}%</div>
        </div>
      ...
      <div class="family" v-else-if="astState === 3 && showType == 2 && nowUsrMsg.pk_data">
        ...
        <div class="familyMsg noOpen" v-else>
          ...
          <div class="tipsMsg">
            <p class="noOpponents">{{lang.emty}}</p>
      ...
      <div class="last3" v-else-if="astState === 3 && showType == 3">
        <div class="last">
          ...
          <div class="btn" @click="goCommitSong()" v-if="nowUsrMsg.show">{{lang.upSong}}</div>
        </div>
        <div class="linerBox" v-if="nowUsrMsg.level <3">
          <strong>{{lang.scoreTips}} {{nowUsrMsg.next?nowUsrMsg.next.name:''}}</strong>
          <div class="liner">
