<template>
  <div class="rankGroups">
    ...
    <div class="typeMainTabs">
      <i class="liner"></i>
      <span class="tab1" @click="setShowType(1)" :class="{act:showType == 1}"><strong>{{lang.tab1}}</strong> <em>{{getDate(stime1,1)}}-{{getDate(etime1,1)}}</em> </span>
      <span class="tab2" @click="setShowType(2)" :class="{act:showType == 2}"><strong>{{lang.tab2}}</strong><em>{{getDate(stime2,1)}}-{{getDate(etime2,1)}}</em> </span>
      <span class="tab3" @click="setShowType(3)" :class="{act:showType == 3}"><strong>{{lang.tab3}}</strong><em>{{getDate(stime3,1)}}-{{getDate(etime3,1)}}</em> </span>
    </div>
    <!-- 日榜、总榜切换主Tabs -->
    ...
    <div class="downTimebox">
      <div v-if="mainTab == 0 &&  showType ==1" class="timeTips">
        <p v-if="tab == nowDay && actStatus == 1">- {{lang.tmTips1}} -</p>
        <p v-else-if="(tab > nowDay || actStatus == 0) && nowShowType == 1">- {{lang.tmTips2}} -</p>
        <p class="noTime" v-else>- {{lang.tmTips3}} -</p>
      </div>
      <div class="timeTips" v-else-if="mainTab == 1 &&  showType ==1">
        <p v-if="actStatus == 0 ">- {{lang.tmTips4}} -</p>
        <p v-else-if="actStatus == 1&& nowShowType == 1">- {{lang.tmTips5}} - </p>
        <p v-else>- {{lang.tmTips6}} - </p>
      </div>
      <div class="timeTips" v-else-if="showType ==2">
        <p v-if="actStatus == 0 || nowShowType == 1">- {{lang.tmTips7}} -</p>
        <p v-else-if="actStatus == 1&& nowShowType == 2">- {{lang.tmTips8}} - </p>
        <p v-else>- {{lang.tmTips9}} - </p>
      </div>
      <div class="timeTips" v-else-if="showType ==3">
        <p v-if="actStatus == 0|| nowShowType == 1|| nowShowType == 2">- {{lang.tmTips10}} -</p>
        <p v-else-if="actStatus == 1&& nowShowType == 3">- {{lang.tmTips11}} - </p>
        <p v-else>- {{lang.tmTips12}} - </p>
      </div>
      <!-- surplusTime.day &&-->
      ...
      <p class="rankTips" v-if="showType==1 && mainTab == 0">{{lang.rank_scoreTips1}}</p>
      <p class="rankTips" v-if="showType==1 && mainTab == 1">
        {{lang.rank_scoreTips1}}<br />
        {{lang.rank_scoreTips2}}
      </p>
      <p class="rankTips" v-if="showType==2">{{lang.rank_scoreTips1}}<br />
        {{lang.rank_scoreTips3}}<br />
        {{lang.rank_scoreTips4}}
      </p>
      <p class="rankTips" v-if="showType==3">
        {{lang.rank_scoreTips1}}<br />
        {{lang.rank_scoreTips5}}<br />
        {{lang.rank_scoreTips6}}
      </p>
    </div>
    <!-- 日榜 -->
    ...
    <ul v-if="showType ==1" class="list day">
      <li v-for="(item,index) in rank.list" :key="index" :class="'rank'+item.rank" @click="goPeople(item.uid,item.live)">
        ...
        <div class="score">
          ...
          <div class="num" v-if="mainTab==0">{{lang.luckPro}} {{item.pro}}%</div>
        </div>
      ...
      <li v-for="(item,index) in rank.list" :key="index" :class="[{min:item.empty},'rank'+item.rank]">
        ...
        <div class="familyMsg">
          ...
          <div class="family2 family">
            <p class="noOpponents" v-if="item.empty">{{lang.emty}}</p>
