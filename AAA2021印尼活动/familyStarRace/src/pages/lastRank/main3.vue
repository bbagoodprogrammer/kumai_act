<template>
  <div class="lastRank">
    <div class="title">Top Penjaga Famili</div>
    <div class="tips">
      Pemeringkatan berdasarkan nilai pesona hadiah koin yg sawer utk pengguna terdaftar<br />
      Yg top 10 teratas akan dapatkan hadiah besar, tampilkan top 100 teratas di daftar
    </div>
    <p v-if="!list.length" class="noData">Tiada data</p>
    <ul class="list">
    ...
    <div class="myRank" :class="'rank'+rank.rank">
      ...
      <div class="rank noTop" v-else>Blm masuk</div>
      <div class="uerImg">
