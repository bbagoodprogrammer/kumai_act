<template>
  <div class="song">
    ...
    <div class="haSong" v-else>
      <h5>Pilih nyanyian yg paling Anda sukai</h5>
      <div class="songList">
        <ul>
          <li v-for="(item,index) in songList" :key="index">
            ...
            <span class="joinBtn" @click="choiceSong(item.sid,index)">Pilih utk berpartisipasi</span>
          </li>
        </ul>
      </div>
    ...
    <div class="tipsBox">
      <p class="tips"><i>1.</i>Nyanyian utk ikut acara harus adalah nyanyian apapun yg dipublikkan setelah pukul 18:00:00 tgl 12 Mar (kecuali vokal 5 menit).</p>
      <p class="tips"><i>2.</i>Setiap UID bisa upload beberapa nyanyian utk ikut acara,data hadiah dari nyanyian akan dihitung setelah mendaftar</p>
      <p class="tips"><i>3.</i>Jika nyanyian yg ikut acara dihapus, nilai pesona dan hadiah yg diperoleh dari nyanyian tersebut akan tidak dihitung.</p>
    </div>

    <div class="determinePup" v-if="showPup">
      <div class="determinCon">
        <p>Yakin kirim nyanyian ini utk ikut acara?</p>
        <div class="chang">
...
export default {
  ...
  created () {
    document.title = 'Upload nyanyian'
