<template>
  <div class="giftBox">
    <div class="userLv">
      <div class="lv">Lv hari ini <strong>Lv.{{level}}</strong> <i @click="giftPup= true" class="quest"></i></div>
      <!-- <i class="quest" @click="showTipsPup = true"></i> -->
      <div class="score">Nilai bintang hari ini <strong>{{score}}</strong> </div>
    </div>
    <div class="liner">
    ...
    <div class="giftTips">
      Tiap hari mencapai level yg sesuai , Anda dapat menerima hadiah yg sesuai, tiap hari dapat menerimanya 1 kali, menerima hadiah hanya berlaku pada hari ini
    </div>
    ...
    <div class="mask" v-show="giftPup">
      <transition name="slide">
        <div class="giftShow" v-if="giftPup">
          ...
          <div class="tipsBox">
            <p>1.Tiap hari mencapai level yg sesuai , Anda dapat menerima hadiah yg sesuai,tiap hari dapat menerimanya 1 kali, menerima hadiah hanya berlaku pada hari ini</p>
