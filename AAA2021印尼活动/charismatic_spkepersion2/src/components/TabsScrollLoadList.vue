<template>
  <div class="rankGroups">
    ...
    <div class="rankTips">
      <div class="giftTips">
        <p>Nilai bintang = dapatkan jumlah klik like X10 + nilai pesona hadiah koin emas diterima dari nyanyian yg ikut acara</p>
        <p class="timeTips">Ketika 1 angpau yg disponsori, nilai bintang akan ditambah 2%, dan batas atasnya 10%</p>
      </div>
    </div>
    ...
    <div class="downTimeBox2" v-if="mainTab == 1">
      <div v-if="mainTab == 0">
        <p v-if="tab == c_day">Hitung mundur akhir Top Harian</p>
        <p v-else-if="tab > c_day">Hitung mundur mulai Top Harian </p>
        <div class="noTime" v-else>Hitung mundur akhir Top Harian</div>
      </div>
      <div v-if="mainTab == 1">
        <p v-if="actStatus == 0">Hitung mundur mulai Daftar Total</p>
        <p v-else-if="actStatus == 1">Hitung mundur akhir Daftar Total</p>
        <div class="noTime" v-else>Acara telah berakhir</div>
      </div>
      ...
      <ul class="list day">
        <li v-for="(item,index) in rank.list" :key="index" :class="'rank' +item.rank">
          ...
          <div class="msg">
            ...
            <div class="add" v-if="item.rate > 0">Ditambah {{item.rate}}%</div>
          </div>
          <div class="score">
            <!-- Lv.{{item.level}}  -->
            <div class="lv"><em class="lvScore">Nilai bintang:{{item.score}}</em> </div>
            <div class="iconScore">
              <!-- is_prize -->
