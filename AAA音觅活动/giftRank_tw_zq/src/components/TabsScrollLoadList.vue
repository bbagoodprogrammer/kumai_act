<template>
  <div class="rankGroups">
    ...
    <div class="mainTabs" :class="{current:mainTab==1}">
      <a @click.prevent="mainTabClick(0)" href="" :class="{act:mainTab==0}"><img :src="gifts[0]?gifts[0].image:''" alt=""> {{gifts[0]?gifts[0].name:''}}</a>
      <a @click.prevent="mainTabClick(1)" href="" :class="{act:mainTab==1}"> <img :src="gifts[1]?gifts[1].image:''" alt="">{{gifts[1]?gifts[1].name:''}}</a>
...
.rankGroups {
  ...
  position: relative;
  background: #EDEAE3 url(../assets/img/listBg.png) no-repeat;
