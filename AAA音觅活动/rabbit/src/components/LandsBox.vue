...
.landsBox {
    ...
    .btns {
        ...
        a {
            ...
            &.get {
                ...
                animation: getSeed .5s linear infinite alternate;
            }
            &.help {
                width: 1.66rem;
                height: .67rem;
    ...
    .seeds {
        ...
        li {
            ...
            &:first-child {
                width: 41%;
                background: #1e8c66 url("../img/icon_common_seed.png") .1rem center no-repeat;
            ...
            &:last-child {
                width: 58%;
                background: #1f8081 url("../img/icon_crazy_seed.png") .1rem center no-repeat;
                background-size: .5rem .6rem;
                i {
                    background: #a05a8e;
                    border-color: #df9bc1;
