<template>
  <div class="rule">
    ...
    <h6 class="time">活動時間：8月27日12:00- 9月2日23:00</h6>
    <div class="ruleTips" v-show="tab == 0">
      ...
      <h6>日榜時間：</h6>
      <p class="dayTime">
        Day1: 8月27日12:00-8月28日0:00</br>
        Day2: 8月28日0:00-8月29日0:00</br>
        Day3: 8月29日0:00-8月30日0:00</br>
        Day4: 8月30日0:00-8月31日0:00</br>
        Day5: 8月31日0:00-9月1日0:00</br>
        Day6: 9月1日0:00-9月2日0:00</br>
        Day7: 9月2日0:00-9月2日23:00
      </p>
      <h6>幸運等級劃分：</h6>
      <p class="dayTime">
        Lv1： 500驚喜值</br>
    ...
    <div class="giftTips" v-show="tab ==1">
      <div class="giftBox">
        ...
        <span>
          ...
          <strong>夢幻島嶼<br />（<i>3520</i>金幣/個）</strong>
        </span>
        <span>
          <img src="../../assets/img/ruleGift/9.png" alt="">
          <strong>浪漫飛艇座駕</strong>
        </span>
        <span>
      ...
      <h6>總榜獎勵</h6>
      <p>TOP 1： 幸運寶箱徽章（31天）+夢幻島嶼*1（3520金幣/個）+ 浪漫飛艇座駕（31天）+3000金幣+5000金豆</p>
      <p>TOP 2： 幸運寶箱徽章（31天）+夢幻島嶼*1（3520金幣/個 + 浪漫飛艇座駕（31天）+2000金幣+3000金豆</p>
      <p>TOP 3： 幸運寶箱徽章（31天）+夢幻島嶼*1（3520金幣/個 + 浪漫飛艇座駕（31天）+1000金幣+2000金豆</p>
      <p>TOP4-10： 幸運寶箱徽章（31天）+ 浪漫飛艇座駕（31天）+500金幣 + 1000金豆</p>
      <h6>備註：</h6>
