<template>
  <div class="rules">
    ...
    <div class="wardRankTips">
      ...
      <p>2、本活動的作品特定禮物為愛的花束（10金幣）、經典乳霜（99金幣）、慶祝蛋糕（299金幣）</p>
      <p>3、若獲得的特定禮物魅力值相同，則先到達該魅力值的排名在前面</p>
    </div>
    <h5> K房爭霸榜排名規則</h5>
    <div class="kRoomTips">
      <p>1、按照報名活動後在K房上麥獲得特定禮物的魅力值排名</p>
      <p>2、本活動的特定禮物為心意卡（10金幣）、碎鑽胸針（99金幣）、戴森吹風機（299金幣）</p>
    ...
    <div class="coinsTips">
      ...
      <p>2、向報名活動後在K房上麥的用戶贈送心意卡（10金幣）、碎鑽胸針（99金幣）、戴森吹風機（299金幣）禮物，次日凌晨返禮物金幣數的5%金幣。如當天贈送1個價值299金幣的戴森吹風機禮物，則在次日凌晨獎勵15金幣</p>
    </div>
    <h5> 其他說明</h5>
