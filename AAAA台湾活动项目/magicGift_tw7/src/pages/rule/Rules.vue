<template>
  <div class="rules">
    <p class="activeTime">活動時間:3月4日18:00:00-3月13日20:00:00</p>
    <h5> 活動報名</h5>
    <div class="actSingUp">
    ...
    <div class="wardRankTips">
      ...
      <p>2、本活動的作品特定禮物為彩虹糖（10金幣）、四色腮紅（99金幣）、琉璃首飾盒（299金幣）</p>
      <p>3、若獲得的特定禮物魅力值相同，則先到達該魅力值的排名在前面</p>
    </div>
    <h5> K房爭霸榜排名規則</h5>
    <div class="kRoomTips">
      <p>1、按照報名活動後在K房上麥獲得特定禮物的魅力值排名</p>
      <p>2、本活動的特定禮物為草莓特飲（10金幣）、百變粉撲（99金幣）、古典髮簪（299金幣）</p>
    ...
    <h5> 金幣返還獎勵規則</h5>
    <div class="coinsTips">
      <p>1、向報名活動後發佈的公開作品贈送彩虹糖（10金幣）、四色腮紅（99金幣）、琉璃首飾盒（299金幣），次日凌晨返禮物金幣數的5%金幣。如當天贈送1個價值299金幣的琉璃首飾盒禮物，則在次日凌晨獎勵15金幣</p>
      <p>2、向報名活動後在K房上麥的用戶贈送草莓特飲（10金幣）、百變粉撲（99金幣）、古典髮簪（299金幣）禮物，次日凌晨返禮物金幣數的5%金幣。如當天贈送1個價值299金幣的古典髮簪禮物，則在次日凌晨獎勵15金幣</p>
    </div>
    <h5> 其他說明</h5>
