<template>
  <div class="bigBox">
    <div class="header">
      <a href="./index2.html" :class="{shareTop:isShare}">規則獎勵</a>
    </div>
    ...
    <div class="listTab">
      ...
      <a href="" class="people" :class="{active:showComponent === 'people'}" @click.prevent="updatePeople('people')">人氣爭霸榜</a>
    </div>
    ...
    <div class="footer" v-if="!isShare">
      ...
      <div class="myMsg" v-show="showComponent === 'works' && (showFooter === 3 || showFooter == 4)">
        ...
        <!-- <div class="imgBox">
          <img src="../assets/img/shi.png" alt="" class="img1" v-if="WardsMyMsg.rank == 1">
      ...
      <div class="myMsg" v-show="showComponent === 'kRoom' && (showFooter === 3 || showFooter == 4)">
        ...
        <div class="imgBox">
          <img src="../assets/img/shi.png" alt="" class="img1" v-if="kRommMyMsg.rank == 1">
      ...
      <div class="myMsg" v-show="showComponent === 'people' && (showFooter === 3 || showFooter == 4)">
        ...
        <div class="imgBox">
          <img src="../assets/img/shi.png" alt="" class="img1" v-if="peopleMyMsg.rank == 1">
...
body {
  ...
  position: relative;
  margin: auto;
  background: #d53889 url(../assets/img/bigBg.png) no-repeat;
