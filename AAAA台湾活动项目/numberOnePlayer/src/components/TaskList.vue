...
export default {
  data() {
    return {
      rankName: {
        login: "- 當天登入活動頁面",
        publicWork: "- 當天發佈一首公開作品",
        last_publicWork: "- 前一天發佈的任意一首公開作品未刪除",
        praise: "- 給10個不同的作品點讚",
        share: "- 分享一首公開作品到站外",
        online: "- 當天在任意K房停留15分鐘及以上",
        kmic_start: "- 當天在任意K房上麥演唱1次",
        radio_online: "- 當天在語聊房停留15分鐘",
        sendBean: "- 當天送禮100金豆以上",
        sendCoin: "- 當天累計送禮金幣達到",
        charge: "- 當天累計儲值金幣達到",
      },
      wholePup: false,
  ...
  methods: {
    ...
    share() {
      globalBus.$emit('commonEvent', callback => {
        ...
        var data = {
          "share_title": "好玩！我正在打地鼠抽獎兌選票",
          "share_content": "快幫我加油贏遊戲幣吧！",
          "share_image": "http://activity.17sing.tw/static_html/2019/numberOnePlayer/share.png",
          "link": `http://activity.17sing.tw/static_html/2019/numberOnePlayer/index.html?uid=${this.groupsUserMsg[2].msg.uid}`,
          "image": "http://activity.17sing.tw/static_html/2019/numberOnePlayer/share.png",
        }
        if (ios) {
          // if (window.share != undefined) {
          //   share(JSON.stringify(data))
          // } else {
          location.href = 'shareUserInfo://http://activity.17sing.tw/static_html/2019/numberOnePlayer/index.html&shareText=快幫我加油贏遊戲幣吧！&userImg=http://activity.17sing.tw/static_html/2019/numberOnePlayer/share.png&title=好玩！我正在打地鼠抽獎兌選票';
          // }
        } else {
          if (getAppUaInfo(ua).ver >= 670682) {
            javascript: JSInterface.share(JSON.stringify(data));
          } else {
            javascript: JSInterface.share('http://activity.17sing.tw/static_html/2019/numberOnePlayer/index.html?uid=' + this.groupsUserMsg[2].msg.uid + '', '好玩！我正在打地鼠抽獎兌選票', '快幫我加油贏遊戲幣吧！', 'http://activity.17sing.tw/static_html/2019/numberOnePlayer/share.png');
          }
        }
      })
    }
