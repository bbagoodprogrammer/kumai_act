<template>
  <div class="game">
    <div class="gheader">
      ...
      <span class="lvbar">
        <span class="lv"><strong>Lv.{{nowGrade.grade?nowGrade.grade:0}}</strong><i></i><strong>Lv.{{nextGrade}}</strong></span>
        <span class="bar"><i :style="{width:linerWidth + '%'}"></i></span>
    ...
    <div class="gmain">
      <div v-show="!loading" class="gbar">
        <span><strong>{{lang.TotalScore}}</strong><em>{{score}}</em></span>
      ...
      <div class="gcanvas">
        ...
        <transition name="fade">
          <div v-show="!loading&&!gaming && !isUpLoading" class="start">
            ...
            <div class="tips">{{lang.mouseTips1}}<br>{{lang.mouseTips2}}</div>
          </div>
        </transition>
        ...
        <transition name="slide">
          <div class="noConis" v-show="showNoCoins">
            <div class="noCoinsCon">
              ...
              <p>{{lang.noCoinsTips1}}</br>{{lang.noCoinsTips2}}</p>
        ...
        <transition name="slide">
          <div class="result" v-show="showResult">
            <div class="resultCon">
              ...
              <p>{{lang.NowScore}} <em>{{score}}</em></br>{{lang.AchieveLv}}<em>Lv. {{nowGrade.grade}}</em></p>
