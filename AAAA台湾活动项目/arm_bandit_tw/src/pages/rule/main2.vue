<template>
  <div class="rule">
    ...
    <ol>
      ...
      <li>4.抽500老虎幣/次模式滿40次必中幸運兌換券或4-6位新靚號，抽中獎勵的用戶，官方號UID會在本期活動結束7天內與您聯繫，請您選擇兌換獎勵內容：抽中靚號的用戶可以兌換新靚號，幸運券可以兌換榮譽積分商城15000積分或者6000金豆，不想兌換靚號的用戶可以兌換榮譽積分商城15000積分或者6000金豆
        <br />（榮譽積分商城積分只能發放給 獲得進入榮譽積分商城資格的用戶）
      </li>
      <li>5.該活動獲得的金豆背包禮物獎勵，安卓版本可在我-背包中查看，而且送禮時，選擇背包禮物送出。IOS可前往app store 搜尋最新版本“高歌”，下載使用</li>
      <li> 6.關於抽500老虎幣模式滿40次必中幸運兌換券或4-6位新靚號，每期活動每位用戶僅有1次機會</li>
    </ol>
