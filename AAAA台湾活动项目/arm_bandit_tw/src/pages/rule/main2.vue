<template>
  <div class="rule">
    ...
    <ol>
      ...
      <li>4.抽500老虎幣/次模式滿20次必中7位數靚號，抽中7位數靚號獎勵，官方號UID10會在本期活動結束7天內與您聯繫，在官方提供的靚號範圍內篩選確認靚號號碼，以及需要提供未在歡歌平台註冊過的手機號碼進行綁定</li>
      <li>5.該活動獲得的金豆背包禮物獎勵，安卓版本可在我-背包中查看，而且送禮時，選擇背包禮物送出。IOS可前往app store 搜尋最新版本“高歌”，下載使用</li>
      <li>6.關於抽500老虎幣模式滿20次必中7位數靚號，每期活動中每位用戶僅有1次機會</li>
    </ol>
