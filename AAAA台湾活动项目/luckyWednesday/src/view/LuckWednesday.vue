<template>
  <div class="box">
    ...
    <div class="discountCon">
      <div class="discountTitle"></div>
      <ul class="wardsList">
        <li v-for="(item,value,index) in gifts" :class="{astTop:item.type == 'K房'}" :key=index>
          <div class="imgBox">
            <img :src="imgArr[value]" alt="" :class="{minImg:item.type == 'K房'}">
          ...
          <div class="nowPriceBox">
            ...
            <span @click="buyWards(value)">點擊購買</span>
          </div>
        </li>
      </ul>
    </div>
...
.box {
  ...
  .discountCon {
    ...
    .discountTitle {
      width: 2.59rem;
      height: 0.44rem;
      background: url(../assets/img/背包禮物折扣字体.png);
      background-size: 100% 100%;
      margin: 0 auto;
    }
    .wardsList {
