  ...
  <div class="home__container">
    ...
    <RuleDialog v-if="ruleVisible" :visible.sync="ruleVisible">
      <div class="rule__dialog">
        ...
        <div class="des">{{lang.rule_des3}}</div>
        <div class="des">{{lang.rule_des4}}</div>
...
export default {
  ...
  computed: {
    ...
    getStoreHtml () {
      return this.lang.current_store
        .replace('{0}', `<span>${this.amount}</span>`)
        .replace('{1}', `<img src=${require('../assets/images/coin.png')} />`)
    }
  },
  ...
  .main {
    ...
    .main__box {
      ...
      .item__box {
        ...
        box-shadow: 15px 0px 10px -10px RGBA(63, 167, 234, 1);
      }
      .item__box::before {
        content: '';
        width:160px;
      ...
      .item__box:last-child {
        ...
        box-shadow: 0px 15px 10px -10px RGBA(63, 167, 234, 1), 15px 0px 10px -10px RGBA(63, 167, 234, 1);
      }
  ...
  .mul__prize__box {
    ...
    .prize__item {
      ...
      .prize__img__box {
        width: 166px;
        height: 166px;
        background: url('../assets/images/prize__box_yellow_bg.png');
        background-size: 100% 100%;
        background-repeat: no-repeat;
        display: flex;
        align-items: center;
