  ...
  <div class="songVote" @click="closeMusic()">
    ...
    <div class="chioneChange">
      ...
      <p class="chioneTips">
        ...
        3. ستتلقى كل 8 أصوات متتالية التي تفوز بلتصويت المسابقة الحالية هدايا عشوائية: ستتلقى كل 8 أصوات متتالية التي تفوز بلتصويت المسابقة الحالية هدايا عشوائية: مروحة هوائية الورقية*1（100 فول ذهبي）\
        فقاعات*3（90 فول ذهبي）\ جيد*1（3 عملات）\VIP(يومين)\سيارة خروف ملون(يومين)
