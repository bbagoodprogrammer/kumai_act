<template>
  <div class="bigBox">
    <div class="header">
      <a href="./index2.html" :class="{shareTop:isShare}">Aturan&Hadiah</a>
    </div>
    ...
    <div class="listTab">
      ...
      <a href="" class="kRoom" :class="{active:showComponent === 'kRoom'}" @click.prevent="updateKroom('kRoom')">Daftar hegemoni kamar karaoke</a>
    ...
    <div class="footer" v-if="!isShare">
      ...
      <div class="myMsg" v-show="showComponent === 'works' && (showFooter === 3 || showFooter == 4)">
        ...
        <div class="msgTop">
          <em>Nilai pesona hadiah nyanyian</em>
          <strong>{{WardsMyMsg.score}}</strong>
        </div>
        <div class="msgTop">
          <em>Peringkat nilai pesona hadiah nyanyian</em>
          <strong>{{WardsMyMsg.rank}}</strong>
        </div>
      </div>
      <div class="myMsg" v-show="showComponent === 'kRoom' && (showFooter === 3 || showFooter == 4)">
        ...
        <div class="msgTop">
          <em>Nilai pesona hadiah kamar karaoke</em>
          <strong>{{kRommMyMsg.score}}</strong>
        </div>
        <div class="msgTop">
          <em>Peringkat nilai pesona hadiah kamar karaoke</em>
          <strong>{{kRommMyMsg.rank}}</strong>
        </div>
      </div>
      <div class="myMsg" v-show="showComponent === 'people' && (showFooter === 3 || showFooter == 4)">
        ...
        <div class="msgTop">
          <em>Jumlah org yg antar hadiah</em>
          <strong>{{peopleMyMsg.score}}</strong>
        </div>
        <div class="msgTop">
          <em>Peringkat jumlah org yg antar hadiah</em>
          <strong>{{peopleMyMsg.rank}}</strong>
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    showFooter() {  //底部現實組件
      ...
      if (activite === 0) { //Acara belum mulai
        return 0
  ...
  methods: {
    ...
    uploadSong() {
      if (this.isShare) {
        ...
        this.showT = true
        this.tastMsg = `Acara belum mulai`
        return
      } else if (this.activite === 2) {
        this.showT = true
        this.tastMsg = `Acara udah selesai`
        return
      } else {
        let regstr = getString('token')
...
body {
  ...
  position: relative;
  margin: auto;
  background: #652fff url(../assets/img/bigBg.png) no-repeat;
