<template>
  <div class="kroom" :class="{active:activateState === 0}">
    <div class="wardsSample">
      <p class="rankTips"> <strong>Ini akan menurut nilai pesona hadiah berikutnya yang didapatkan di kamar karaoke setelah pendaftaran untuk melakukan peringkat.</strong> </p>
      <div class="wards">
        <div class="wardItem">
          <img src="../assets/img/ward4.png" alt="">
          <strong>Bebek kecil</strong>
        </div>
        <div class="wardItem">
          <img src="../assets/img/ward5.png" alt="">
          <strong>Pistol air</strong>
        </div>
        <div class="wardItem">
          <img src="../assets/img/ward6.png" alt="">
          <strong>Kereta api kecil</strong>
        </div>
      </div>
      <p class="fansong">Mengantar hadiah yg atas kepada peserta di kamar karaoke , pengguna yg mengantar hadiah akan dikembalikan 5% koin emas yg harga hadiahnya pada pukul 24:00 hari ini. </p>
    </div>
