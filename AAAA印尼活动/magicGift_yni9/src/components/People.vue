<template>
  <div class="words" :class="{active:activateState === 0}">
    <div class="wardsSample">
      <p>Ini akan menurut total jumlah orang yg sawer hadiah tertentu di kamar karaoke atau nyanyian yg diposting setelah pendaftaran untuk melakukan peringkat
        <em> Pengguna yg sama mengantar hadiah terus,hanya dihitung 1 kali</em>
      </p>
      <!-- <div class="wards">
        <div class="img"></div>
        <div class="wardName">
