<template>
  <div class="result">
    <div class="resultCon">
      ...
      <p class="titale">Hasil pembukaan taruhan</p>
      <p class="tips">Jika nilai/poin yang sama dari tiga dadu,meskipun nilai dadu adalah besar atau kecil,tunggal atau ganda,yang menang dari pihak Wekara</p>
      <div class="listToby">
        <span class="time">Waktu penebusan</span>
        <span class="openres">Hasil pembukaan</span>
        <span class="down">Taruhan yg sebenarnya</span>
        <span class="wd">Kalah Menang</span>
      </div>
      <ul class="scrollable">
