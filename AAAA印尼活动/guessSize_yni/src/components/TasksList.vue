<template>
  <div class="taskList">
    <div class="taskListCon">
      ...
      <p class="titale">
        Melakukan tugas untuk mendapatkan lebih banyak jumlah bet
      </p>
      <div class="listToby">
        <span class="time">Tugas</span>
        <span class="openres">Jumlah bet</span>
        <span class="down">Kemajuan</span>
      </div>
      <ul class="list">
...
export default {
  ...
  data() {
    return {
      taskName: {
        publicWork: "Publikasikan X nyanyian secara publik",
        share: "Share satu nyanyian yang publik ke situs web lain(misalnya: FB dan lain lain)",
        kmic_start: "Bernyanyi di kamar karaoke",
        online: "Stay di kamar karaoke lebih dari X menit",
        radio_online: "Stay di kamar obrolan lebih dari X menit",
        charge: "Total top up mencapai X koin emas ",
        sendCoins: "Total sawer mencapai X koin emas ",
        KTVcharms: "Nilai pesona koin emas dari kamar karaoke  mencapai X",
        SongCoinsCharm: "Nilai pesona koin emas dari nyanyian mencapai X"
      }
    }
  },
  methods: {
