...
export default {
  ...
  data() {
    return {
      ...
      activeIndex2: null,
      activeIndex3: null,
      point1: [{ choice: 'Besar 11~17', key: 'first_1', img: require('../assets/img/da.png') },
      { choice: 'Kecil 4~10', key: 'first_2', img: require('../assets/img/xiao.png') },
      { choice: 'Sum adalah tunggal', key: 'first_3', img: require('../assets/img/dan.png') },
      { choice: 'Sum adalah ganda', key: 'first_4', img: require('../assets/img/shuang.png') }
      ],
      ...
      point3: [{ choice: '4,17', multiple: '33', key: 'third_1', img: require('../assets/img/point3-1.png') },
      { choice: '5,16', multiple: '18', key: 'third_2', img: require('../assets/img/point3-2.png') },
      { choice: '6,15', multiple: '10', key: 'third_3', img: require('../assets/img/point3-3.png') },
      { choice: '7,14', multiple: '7', key: 'third_4', img: require('../assets/img/point3-4.png') },
      { choice: '8,13', multiple: '5', key: 'third_5', img: require('../assets/img/point3-5.png') },
      { choice: '9,10,11,12', multiple: '3', key: 'third_6', img: require('../assets/img/point3-6.png') },
      ]
    }
  },
  methods: {
