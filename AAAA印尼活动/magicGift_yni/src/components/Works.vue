<template>
  <div class="words" :class="{active:activateState === 0}">
    <div class="wardsSample">
      <p>Ranking menurut ini : Posting/mengumumkan nyanyian setelah mendaftar,dan mendapatkan nilai pesona hadiah berikut</p>
      <div class="wards">
        <div class="wardsImg">
          <span class="water">
            <img src="../assets/img/shuijing.png" alt="">
            <em>Ikat kepala kartun</em>
          </span>
          <span class="cun">
      ...
      <p class="fansong">Sawer hadiah yang di atas ke nyanyian yang ikut acara,sistem akan kembalikan 5% koin emas dari jumlah koin emas hadiah kepada orang yang sawer pada pukul 0:00:00.</p>
    </div>
