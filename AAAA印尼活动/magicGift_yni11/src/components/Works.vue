<template>
  <div class="words" :class="{active:activateState === 0}">
    <div class="wardsSample">
      <p>Ini akan menurut nilai pesona hadiah berikutnya yang didapatkan dari nyanyian yg diposting setelah pendaftaran untuk melakukan peringkat.</p>
      <div class="wards">
        <div class="img">
        ...
        <div class="wardName">
          <em>Bendera berkat</em>
          <em>Tarian perayaan festival </em>
          <em>Kembang api festival</em>
        </div>
      </div>
      <div class="fansong">Mengantar hadiah yg atas kepada nyanyian yg ikut acara, pengguna yg mengantar hadiah akan dikembalikan 5% koin emas yg harga hadiahnya pada pukul 24:00 hari ini.</div>
    </div>
