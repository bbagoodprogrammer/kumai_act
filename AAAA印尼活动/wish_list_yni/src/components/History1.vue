<template>
  <div class="history1">
    <p v-if="history1.list && history1.list.length == 0" class="tips">Sekarang belum ada data</p>
    <ul class="scrollable" v-else>
      <li v-for="(item,index) in history1.list" :key="index">
        ...
        <p class="tips">Telah menyelesaikan lagu keinginan Anda</p>
        <div class="auido">
        ...
        <div class="score">
          <p class="scoreTitle">Skor kepuasan</p>
          <div class="scoreBox">
      ...
      <p v-show="loading" class="loadingTips">Loading...</p>
    </ul>
