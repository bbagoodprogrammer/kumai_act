<template>
  <div class="rule">
    ...
    <div class="ruleMsg" v-show="showTab == 'tab1'">
      ...
      <p>4. Setelah ambil keinginan,silakan mengantar lagu keinginan sebelum lewati 24 jam, jika tidak keinginan ini akan menjadi keterangan ditunggu ambil ,kamblikan daftar keinginan.</p>
