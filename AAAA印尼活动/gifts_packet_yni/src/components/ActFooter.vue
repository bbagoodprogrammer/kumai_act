<template>
  <div class="footerBar">
    <div class="acrStatus">
      <span class="noAct" v-if="astState === 0">Acara blm mulai</span>
      <span class="noAct" v-if="astState === 2">Acara udh berakhir</span>
      <span class="goAct" v-if="astState === 1" @click="singUp()">Mendaftar</span>
