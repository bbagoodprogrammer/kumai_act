...
export default {
  data() {
    return {
      rankName: {
        login: "- Login halaman acara pada hari ini",
        ...
        praise: "- klik like kepada 10 nyanyian yang berbeda",
        share: "- Bagikan 1 nyanyian ke situs web lain",
        ...
        radio_online: "-Stay di kamar obrolan lebih dari 15 menit pada hari ini",
        sendBean: "- Sawer 100 kacang emas pada hari ini",
        sendCoin: "- Sawer koin emas pada hari ini sampai ",
        charge: "- Total top up koin emas pada hari ini mencapai",
      },
      wholePup: false,
      nowTask_list: [],
      finish_count: 0
  ...
  methods: {
    ...
    share() {
      globalBus.$emit('commonEvent', callback => {
        ...
        var data = {
          "share_title": "mantap！saya sedang pukul tikus utk undian",
          "share_content": "bantu saya dapat koin main kok! ",
          "share_image": "https://activity.wekarapp.com/static_html/2019/numberOnePlayer/share.png",
          "link": `https://activity.wekarapp.com/static_html/2019/numberOnePlayer/index.html?uid=${this.groupsUserMsg[2].msg.uid}`,
          "image": "https://activity.wekarapp.com/static_html/2019/numberOnePlayer/share.png",
        }
        if (ios) {
          // if (window.share != undefined) {
          //   share(JSON.stringify(data))
          // } else {
          location.href = 'shareUserInfo://https://activity.wekarapp.com/static_html/2019/numberOnePlayer/index.html&shareText=bantu saya dapat koin main kok!&userImg=https://activity.wekarapp.com/static_html/2019/numberOnePlayer/share.png&title=mantap！saya sedang pukul tikus utk undian';
          // }
        } else {
          // if (getAppUaInfo(ua).ver >= 670682) {
          //   javascript: JSInterface.share(JSON.stringify(data));
          // } else {
          javascript: JSInterface.share('https://activity.wekarapp.com/static_html/2019/numberOnePlayer/index.html?uid=' + this.groupsUserMsg[2].msg.uid + '', 'mantap！saya sedang pukul tikus utk undian', 'bantu saya dapat koin main kok! ', 'https://activity.wekarapp.com/static_html/2019/numberOnePlayer/share.png');
          // }
        }
      })
    }
