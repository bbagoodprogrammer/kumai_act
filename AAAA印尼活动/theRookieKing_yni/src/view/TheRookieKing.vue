<template>
  <div class="box">
    ...
    <div class="header">
      <a href="./index2.html" class="rules">Aturan & Hadiah</a>
      <a href="" class="history" @click.prevent="godebutList()">Top Debut</a>
    ...
    <div class="wards">
      ...
      <div class="wardsItem">
        ...
        <div>
          ...
          <span>Lencana</br> Newcomer King </span>
        </div>
        <div>
          <img src="../assets/img/wardsBg.png" alt="" class="imgBg">
          <img src="../assets/img/coin.png" alt="" class="imgB2">
          <span>Koin emas </br>besar-besaran</span>
        </div>
        <div>
          <img src="../assets/img/wardsBg.png" alt="" class="imgBg">
          <img src="../assets/img/beans.png" alt="" class="imgB2">
          <span>Kacang emas </br>besar-besaran</span>
        </div>
      </div>
    </div>
    <div class="listRules">
      ...
      <p class="listMsg">
        Skor daftar =Nilai pesona koin emas +nilai pesona kacang emas (termasuk nilai pesona hadiah ransel dari kamar karaoke) yang didapatkan oleh pengguna di kamar karaoke apapun selama kontes
      </p>
    </div>
