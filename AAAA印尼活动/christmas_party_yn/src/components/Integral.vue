      ...
      <div class="receivePup" v-if="showGiftPup">
        <div class="receivePupCon">
          ...
          <div class="type" v-if="type == 1">
            ...
            <p class="giftName" v-else>Kartu double hadiah acak,1 hadiah*2 dengan acak dari 3 buah hadiah yang didapatkan pada hari ini</p>
            <p class="bean" v-if="giftIndex== 0">(Telah berturut mencapai {{gift_list.continue_login_counts}} hari)</p>
            <span class="lingqu" :class="{act:gift_list.gift_list[giftIndex].is_get == 0 && sucStep>=(giftIndex+1)}" @click="receive()">{{gift_list.gift_list[giftIndex].is_get==0?'Menerima':'Telah menerima'}}</span>
          </div>
          <div class="type2" v-else-if="type == 2">
            <div class="successTi">
              <div class="tips"></div>
              <span> Berhasil menerima</span>
            </div>
            <p class="sucTips">
              Hadiah yang sesuai telah dikirim ke akun Anda, silakan cek!
            </p>
          </div>
          <div class="type3" v-else-if="type == 3">
            ...
            <span class="succeTitle"> Berhasil menerima</span>
            <p class="sucTips">
              Hadiah yang sesuai telah dikirim ke akun Anda, silakan cek!
            </p>
          </div>
