  ...
  <div class="box">
    ...
    <div class="header">
      ...
      <div class="ruleBox" :class="{top:isShare}">
        <span class="ruleTips" @click="goRule()">Hadiah&Aturan</span>
        <span class="history" @click="goHistory()">Riwayat ></span>
      </div>
    </div>
    <integral></integral>
    ...
    <transition name="slide">
      <div class="firstPup" v-if="showFirstGift">
        <div class="firstCon">
          <div class="title"></div>
          <div class="getIntegral" @click="doTask()">Masuk utk mendapatkan poin>></div>
          <div class="giftItem">
            <span class="close" @click="closeFirstPup()"></span>
            <div class="giftOne">
              <span>Nilai poin 70</span>
              <div class="imgBox">
                <img src="../assets/img/PupImg/ward0.png" alt="">
              </div>
              <em>{{gift_list.gift_list[0].counts}} Kacang emas</em>
            </div>
            <div class="giftOne">
              <span>Nilai poin 90</span>
              <div class="imgBox">
            ...
            <div class="giftOne">
              <span>Nilai poin 150</span>
              <div class="imgBox">
                <img src="../assets/img/PupImg/ward3.png" alt="">
              </div>
              <em>acak 1 hadiah *2 dari 3 hadiah yg lalu</em>
            </div>
          </div>
        </div>
      </div>
