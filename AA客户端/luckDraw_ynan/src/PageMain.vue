<template>
  <div class="page pageMain">
    ...
    <div class="turnBox">
      ...
      <div class="luckMsg">
        <div class="noLuck" v-if="!luckMsg || (luckMsg&&!luckMsg.id)">Chưa có rút thưởng</div>
      ...
      <div class="sGiftTips" v-if="luckMsg&&luckMsg.status == 1">Tặng <img :src="luckMsg.ticket_gpic" alt="">x1 được rút thưởng</div>
