<template>
  <div class="page pageMain">
    ...
    <div class="turnBox">
      ...
      <div class="luckMsg">
        <div class="noLuck" v-if="!luckMsg || (luckMsg&&!luckMsg.id)">Tiada undian saat ini</div>
        <div class="luckIng" v-else>
          <div class="msg">
            <span v-if="luckIng">Sedang undian...</span>
      ...
      <div class="sGiftTips" v-if="luckMsg&&luckMsg.status == 1">Akan bisa mengikut undian stlh kirim <img :src="luckMsg.ticket_gpic" alt="">x1</div>
