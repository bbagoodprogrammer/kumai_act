<template>
  <div class="page pageHistoryDetail">
    ...
    <div class="luckUser">
      <div class="title">Menangkan hadiah besar!</div>
      <div class="userMsg">
        <div class="imgBox">
          <span class="bg"></span>
        ...
        <div class="userName">
          ...
          <div class="gift">Hadiah: <img :src="actItem.prise_pic" alt=""> x1</div>
        </div>
      </div>
    </div>
    <div class="sGift">
      <span class="gift">Kualifikasi undian: <img :src="actItem.ticket_gpic" alt=""> x1</span>
      <span>Pemilik pemulai: {{actItem.creator_nick}}</span>
    </div>
    <div class="list">
      <div class="total">Jumlah peserta: {{total?total:0}}</div>
      <ul class="scrollable">
        <li v-for="(item,index) in list " :key="index">
          <img :src="item.avatar" alt="">
          <div class="msg">
            <div class="nick">{{item.nick}}</div>
            <div class="tips">Kirim {{item.ticket_count}} hadiah, dptkn {{item.ticket_count}} kesempatan undian</div>
          </div>
        </li>
      </ul>
    </div>
