<template>
  <div class="trun">
    ...
    <p class="tips">
      استمر في إنفاق العملات الذهبية {{userMsg.diff_ktvgift}} لتحصل على تذكرة يانصيب</br>
  ...
  methods: {
    go() {
      ...
      if (this.userMsg.ticket > 0) {
        ...
        this.tastMsg = `تذكرة اليانصيب الخاصة بك غير كافية ، اذهب واحصل على تذكرة اليانصيب!`
        this.showT = true
      }
    },
    turnAngle() {
