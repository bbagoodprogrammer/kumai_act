    ...
    <div class="tips1" :style="{height:pupHeight+'px'}" v-show="showTips">
      <transition name="slide">
        <div class="tipsCon" v-show="showTips">
          ...
          <div class="con">
            <p>1.مقابل كل 1000 عملة ذهبية يتم إنفاقها في المجموع ، يمكن تحويل السحب</p>
            <p>2.يمكنك الحصول على مفتاح مفاجأة لكل قيمة متراكمة من 3000 عملة ذهبية.يمكن استخدام مفتاح المفاجأة لفتح صندوق الكنز المفاجئ</p>
            <p>3.يمكن استبدال شظايا الهدايا بهدايا نادرة في صندوق الهدايا ، والهدايا النادرة هي هدايا غرفة الغناء</p>
            <p>4.يمكن استخدام أجزاء الملصقات لاسترداد مجموعة الملصقات بالكامل. فترة صلاحية الملصقات 30 أيام.</p>
            <p>5.للمرة الثالثة والثامنة من صندوق الكنز المحظوظ ، سيتم ربح العناصر النادرة .</p>
