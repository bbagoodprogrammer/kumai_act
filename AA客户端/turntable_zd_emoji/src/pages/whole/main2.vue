<template>
  <div id="box">
    <div class="turnHeader">
      <div class="tabs">
        <span class="trun" :class="{act:shoCom=='Trun'}" @click="tabClick('Trun')">عجلة الحظ</span>
        <span class="trunBox" :class="{act:shoCom=='Box'}" @click="tabClick('Box')">صندوق كنز مفاجئ</span>
