  ...
  <div class="share">
    ...
    <div class="singInDay" :class="{mHeigth:type==2}">
      <div class="userMsg" v-if="type==2">
        ...
        <div class="userTips">Sudah sign-in {{days}} hari dengan terus-menurus, skrg perlu bantuanmu, cepatlah bantu dia.</div>
      </div>
      <strong v-else>
    ...
    <div class="shareTips">
      <div class="shareBtn" v-if="isOver ||leftTime<=0">Besok coba lagi</div>
      <div class="shareBtn" @click="share()" v-else> {{type==2?'Bantu dia':'Segara undang teman'}} </div>
      <p class="verTips" v-if="type==2"> Harus update versi terbaru baru bisa bantu.</p>
      ...
      <div class="tips" v-else>
        <h6>Aturan bantu:</h6>
        <p>1、Tidak bisa membantu diri sendiri</p>
        <p>2、Setiap pengguna cuma bisa membantu pengguna lain sekali sehari</p>
        <p>3、Harus update versi terbaru, baru bisa berhasil bantu</p>
        <p>4、Bantuan perlu diselesaikan dalam waktu terbatas,tidak bisa bantu kalau lewatkan waktunya,dan perlu undang lagi besok</p>
      </div>
    </div>
    <Loading />
  </div>
