<template>
  <div class="page pageHistoryDetail">
    ...
    <div class="luckUser">
      <div class="title"> ارسم الجائزة الكبرى!</div>
      <div class="userMsg">
        <div class="imgBox">
          <span class="bg"></span>
        ...
        <div class="userName">
          ...
          <div class="gift">جائزة: <img :src="actItem.prise_pic" alt=""> x1</div>
        </div>
      </div>
    </div>
    <div class="sGift">
      <span class="gift"> الأهلية لليانصيب: <img :src="actItem.ticket_gpic" alt=""> x1</span>
      <span>البادئ: {{actItem.creator_nick}}</span>
    </div>
    <div class="list">
      <div class="total"> عدد المشاركين: {{total?total:0}}</div>
      <ul class="scrollable">
        <li v-for="(item,index) in list " :key="index">
          ...
          <div class="msg">
            ...
            <div class="tips">
              أرسل هدايا {{item.ticket_count}} واحصل على فرص{{item.ticket_count}} اليانصيب
            </div>
          </div>
        </li>
      </ul>
