      ...
      if (this.type == 2) {
        ...
        if (ios) {
          if (window.shareOutside != undefined) {
            ...
            location.href = `shareUserInfo://17sing.tw/singIn_tw_new/html/index3.php?inviteCode=${this.inviteCode}&type=2&shareText=Tôi đã điểm danh liên tục ${this.days} ngày, được lật bài nhận thưởng, cần bạn hỗ trợ, mau đến ngay&userImg=${this.master.headImg}&title=Đã điểm danh liên tục ${this.days} ngày`;
          }
        } else {
