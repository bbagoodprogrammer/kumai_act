<template>
  <div class="sharePeople" :class="{pt:surplusTime.end || leftTime<=0}">
    <div class="time" v-if="!surplusTime.end && surplusTime.seconds >0">{{lang.share_downTm}} {{surplusTime.hour}}:{{surplusTime.minute}}:{{surplusTime.second}}</div>
