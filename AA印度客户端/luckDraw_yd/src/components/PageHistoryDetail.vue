<template>
  <div class="page pageHistoryDetail">
    ...
    <div class="luckUser">
      <div class="title">{{lang.history_bigLuck}}</div>
      <div class="userMsg">
        <div class="imgBox">
          <span class="bg"></span>
        ...
        <div class="userName">
          ...
          <div class="gift">{{lang.page_gift}} <img :src="actItem.prise_pic" alt=""> x1</div>
        </div>
      </div>
    </div>
    <div class="sGift">
      <span class="gift">{{lang.history_eligibility}} <img :src="actItem.ticket_gpic" alt=""> x1</span>
      <span>{{lang.history_startP}} {{actItem.creator_nick}}</span>
    </div>
    <div class="list">
      <div class="total">{{lang.history_jionsNums}} {{total?total:0}}</div>
      <ul class="scrollable">
        <li v-for="(item,index) in list " :key="index">
          ...
          <div class="msg">
            ...
            <div class="tips">
              {{lang.history_tips.replace('$',item.ticket_count).replace('$',item.ticket_count)}}
            </div>
          </div>
        </li>
      </ul>
