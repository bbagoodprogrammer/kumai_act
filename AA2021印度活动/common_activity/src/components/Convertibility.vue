      ...
      <div class="converGIft">
        ...
        <div class="converGiftState">
          ...
          <div class="noConver" v-else>
            <strong class="noConverTips" v-if="item.limit > 0">{{lang.converNum.replace("X",item.limit)}}</strong>
...
.convertibility {
  ...
  .converItem {
    width: 7.11rem;
    height: 2.91rem;
    background: url(../img/converItem.png);
      ...
      .converGiftState {
        ...
        .noConver {
          ...
          .converBtn {
            width: 2.11rem;
            height: 0.8rem;
            background: url(../img/converBtn.png);
            background-size: 100% 100%;
            line-height: 0.8rem;
            text-align: center;
            font-size: 0.36rem;
