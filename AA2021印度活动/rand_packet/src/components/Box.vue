          ...
          <div class="openBox1PupCon" v-else>
            <div class="gift">
              <div class="giftItem bean" v-if="prizes.bean">
                <span class="giftBg">
                  <img src="../img/gift/bean.png" alt="" class="img1">
                </span>
                <em>{{prizes.bean}}{{lang.bean}}</em>
              </div>
              <div class="giftItem ticket" v-if="prizes.rebate">
                <span class="giftBg">
                  <img src="../img/gift/ticket.png" alt="" class="img2">
                </span>
...
.giftBox {
  height: 7.66rem;
  background: url(../img/boxBg.png) center 0 no-repeat;
  ...
  .blindBoxItem {
    ...
    .boxItem {
      ...
      padding-top: 0.41rem;
      position: relative;
      background: url(../img/letfBoxBg.png);
      ...
      .openBtn {
        ...
        font-weight: 800;
        margin: 0 auto;
        background: url(../img/openBtn1.png);
        background-size: 100% 100%;
        &.open {
          background: url(../img/openBtn3.png);
          background-size: 100% 100%;
        }
      }
    }
  ...
  .openBox1Pup {
    width: 6.23rem;
    height: 6.36rem;
    background: url(../img/openBox1Pup.png);
    background-size: 100% 100%;
    position: absolute;
    left: 0.63rem;
    top: 2.6rem;
  ...
  .openBox2Pup {
    width: 6.23rem;
    height: 5.93rem;
    background: url(../img/gift2Pup.png);
    background-size: 100% 100%;
    position: absolute;
    left: 0.63rem;
    top: 2.6rem;
    ...
    &.gifts {
      height: 8.18rem;
      top: 1.8rem;
      background: url(../img/giftTotalBg.png);
      background-size: 100% 100%;
      .openBox2PupCon {
        height: 5.5rem;
        .gift {
