  ...
  <div class="box">
    ...
    <div class="header">
      <div class="userMaxTips" @click="showNo()">
        ...
        <p>Kartu Tuan Manor Kehormatan</p>
      </div>
      <div class="tipsBox" :class="{top:isShare}">
        <span class="ruleTips mr" @click="goRule()">Hadiah Aturan</span>
        <span class="ruleTips mt" @click="goHistory()">Riwayat kumpulkan</span>
      </div>
    </div>
    <Pats />
    <Bar />
    ...
    <div class="mask" v-show="showUserNo">
      <transition name="slide">
        <div class="topPup" v-if="showUserNo">
          ...
          <h3>Kartu Tuan Manor Kehormatan</h3>
          <p v-if="number == 0">Berhasil kumpulkan 6 pet lucu bisa menjadi Tuan Manor Kehormatan<br />Udah {{complete}} Tuan Manor telah dapatkan sertifikat kehormatan</p>
          <p v-else>Selamat kamu berhasil kumpulkan 6 pet,dan menjadi Tuan Manor ke-{{number}},maka sertifikat ini diberikan utk kamu.</p>
          <span class="no" v-if="number> 0">Nomor kehormatan: NO.{{number}}</span>
        </div>
      </transition>
    </div>
  ...
  .header {
    ...
    .tipsBox {
      ...
      .mt {
        width: 2.14rem;
        margin-top: 0.14rem;
        background: url(../assets/img/tipsBg2.png);
        background-size: 100% 100%;
      }
    }
  }
