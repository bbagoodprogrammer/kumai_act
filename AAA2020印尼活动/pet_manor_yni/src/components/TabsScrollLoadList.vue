<template>
  <div class="rankGroups">
    ...
    <div class="mainTabs">
      <div class="tabs">
        <a @click.prevent="mainTabClick(0)" :class="{current:mainTab==0}" href="">Top pesona pet</a>
        <a @click.prevent="mainTabClick(1)" :class="{current:mainTab==1}" href="">Top pet eksklusif</a>
      </div>
      <a @click.prevent="onRefresh" href="" :style="{transform:'rotate('+rotatePx+'deg)'}" id="refresh"></a>
    </div>
    <div class="tabsTips">
      <p v-if="mainTab==0" class="taotalTips">Peringkat akan menurut total pesona hadiah dari semua pet yg diterima<br />Setiap mengumpulkan lengkap 6 pet lucu, akan tambahkan 1000 nilai pesona dengan extra</p>
      <div class="petTips" v-else>
        ...
        <p class="tips">Peringkat akan menurut jumlah hadiah pet yg diterima,Top 10 akan mendapatkan hadiah yg besar</p>
      </div>
    </div>
