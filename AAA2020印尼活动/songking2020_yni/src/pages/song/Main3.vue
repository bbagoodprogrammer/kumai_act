<template>
  <div class="song">
    ...
    <div class="tipsBox">
      <p class="tips"><i>1.</i>Nyanyian utk ikut acara harus adalah nyanyian apapun yg publik dan diupload setelah pukul 18:00:00 tgl 4 Dec (kecuali 5 menit vocal).</p>
      ...
      <p class="tips"><i>3.</i>Jika nyanyian yg ikut acara dihapus, nilai pesona dan hadiah yg diperoleh dari nyanyian tersebut dihapus akan tidak dihitung.</p>
    </div>
