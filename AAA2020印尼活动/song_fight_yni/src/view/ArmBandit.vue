<template>
  <div class="box">
    ...
    <div class="header">
      <span class="ruleTips" :class="{top:isShare}" @click="goRule()">Aturan hadiah</span>
    </div>
    <FightTabTime />
    <!-- <div class="pSong"> -->
    ...
    <HotSong :length="list.length" @addSong="addSong" :update="update" :is_push="is_push" />
    <act-footer :jun=" jun" :device="device">
    </act-footer>
