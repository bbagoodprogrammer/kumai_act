  ...
  <div class="footerBar">
    <div class="acrStatus">
      ...
      <div class="actIng" v-if="astState === 3" :class="'rank'+myrank.rank">
        ...
        <div class="userMsg">
          <div class="dayScore">{{lang.todayScore}} <i>{{today_wealth}}</i> </div>
          <div class="totalScore">{{lang.totalScore}} <i>{{myrank.score}}</i> </div>
          <div class="lastRank">{{lang.lastRank}} <i>{{myrank.gap}}</i> </div>
        </div>
      </div>
    </div>
  </div>
