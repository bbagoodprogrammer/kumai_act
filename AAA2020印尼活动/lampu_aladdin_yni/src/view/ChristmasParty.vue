  ...
  <div class="box">
    ...
    <div class="header">
      ...
      <div class="ruleBox" :class="{top:isShare}">
        <span class="ruleTips2 ruleTips" @click="goRule()">Hadiah aturan</span>
        <span class="ruleTips ml" @click="goHistory()">Catatan</span>
      </div>
      <div class="lampD"></div>
      <Lamp ref="lamp"></Lamp>
    </div>
    ...
    aniGo() {
      ...
      let parser = new Parser({ disableWorker: true })
        ; (async () => {
          ...
          let fileData1 = await downloader.get('images/lamp1.svga')
          this.svgaData1 = await parser.do(fileData1)
          let fileData2 = await downloader.get('images/lamp2.svga')
