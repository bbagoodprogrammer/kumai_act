<template>
  <div class="taskList">
    <div class="rankListCon">
      <div class="rankTitle">
        <span class="day">Tugas harian</span>
        <span class="point">Nilai panggilan </span>
        ...
        <li v-for="(item,index) in daily_tasks" :key="index">
          ...
          <span class="du">
            <span class="state">
              ...
              <span v-show="item.schule == item.limit" class="suc">Sudah selesaikan </span>
            </span>
          </span>
        </li>
      </ul>
    ...
    <div class="stored">
      ...
      <div class="storedMsg">
        <div class="title">Tugas top up</div>
        <div class="tips">Setiap kali top up 30 koin emas akan bisa
          mendapatkan 10 nilai panggilan
        </div>
        <div class="coins">Hari ini kamu udah top up {{charge}} koin emas</div>
      </div>
      <div class="storeBtn" @click="goStore()">Top up </div>
    </div>
  </div>
</template>
<script>
...
.rankListCon {
  ...
  li {
    ...
    color: #784114;
    font-size: 0.24rem;
    padding: 0.05rem 0.2rem 0 0.4rem;
    font-weight: 600;
    text-align: center;
    position: relative;
    em {
