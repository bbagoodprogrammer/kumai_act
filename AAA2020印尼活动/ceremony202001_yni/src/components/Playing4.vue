<template>
  <div class="playing4">
    <div class="storedTips">
      ...
      <p v-if="type==1"> Dari 27 hingga 28 November, untuk mengucapkan terima kasih kepada semuanya, top up koin emas berapapun Anda akan dapat bonus 10%(tidak termasuk koin emas dari sistem). Top up banyak, bonus banyak! Selama acara, koin bonus akan segera dimasukkan setelah setiap top up berhasil.</p>
    ...
    return {
      ...
      giftArr1: [
        ...
        },
        {
          ...
          name: 'Kacang emas besar-besaran'
        },
        {
          img: require('../assets/img/ticket/gift/gift1.png'),
          name: 'Hadiah kamar Karaoke'
        }
      ],
      listHeight: 0,
      list: {
