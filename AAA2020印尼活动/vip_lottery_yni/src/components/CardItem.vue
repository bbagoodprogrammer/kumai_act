...
export default {
  ...
  computed: {
    ...
    shareLink() {
      return `https://activity.wekarapp.com/static_html/2020/vip_lottery/index.html?code=${this.luckGift.invite_code}`
    }
  },
  methods: {
    goCard() {
    ...
    share(code) {
      globalBus.$emit('commonEvent', callback => {
        ...
        var data = {
          ...
          "link": `https://activity.wekarapp.com/static_html/2020/vip_lottery/index.html?uid=${this.userMsg.uid}&code=${code}&v=2`,
          "image": "https://activity.wekarapp.com/static_html/2020/vip_lottery/share.jpg",
          "share_url": `https://activity.wekarapp.com/static_html/2020/vip_lottery/index.html?uid=${this.userMsg.uid}&code=${code}&v=2`
        }
        if (ios) {
          this.showShare = true
