          ...
          <div class="goVipHtml" v-show="showGoVip">
            ...
            <div class="table">
              <ul>
                ...
                <li>
                  <span class="bor">1 {{lang.timeTips}}</span>
                  <span>2</span>
                </li>
                <li>
                  <span class="bor">3 {{lang.timeTips}}</span>
                  <span>6</span>
                </li>
                <li>
                  <span class="bor">6 {{lang.timeTips}}</span>
                  <span>14</span>
                </li>
                <li>
                  <span class="bor">1 {{lang.year}}</span>
                  <span>30</span>
                </li>
              </ul>
            </div>
...
export default {
  ...
  methods: {
    ...
    goHtml() {
      ...
      location.href = `https://act.wekarapp.com/html/member_new/index.html?token=${token}&uid=${uid}&v=2`
    }
  }
}
</script>
    ...
    .table {
      ...
      ul {
        li {
          ...
          border-bottom: 0.03rem solid #e5a69e;
          span {
            display: block;
            flex: 1;
            text-align: center;
          ...
          .bor {
            border-right: 0.03rem solid #e5a69e;
          }
          &.tabHeader {
            height: 0.8rem;
            background: #e4767b;
