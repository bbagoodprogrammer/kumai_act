<template>
  <div class="rank">
    <h3 class="title">Daftar lagu</h3>
    <p class="tips">Peringkat menurut jumlah pendengar, waktu mendengarkan, dan tambah jumlah follower dari nyanyian ini <em>(Daftar akan diumumkan setelah acara berakhir)</em></p>
    <p class="noData" v-if="list.length == 0">Saat belum ada data</p>
    <ul>
