    ...
    <div class="rule__container">
      ...
      <div class="tabs">
        <div
          class="tab"
          @click="handleTab(0)"
          :class="{ tab_select_left: currentTab == 0 }"
        >
          {{ lang.act_rule_title }}
        </div>
        <div
          class="tab"
          @click="handleTab(1)"
          :class="{ tab_select_right: currentTab == 1 }"
        >
  ...
  methods: {
    ...
    getBrHtml(text) {
      return text
        ...
        .replace(
          "%1",
          '<a href="https://activity.udateapp.com/static_html/chat_explain/index.html?aid=42" >'
        )
        .replace("%2", '</a>');
    },
