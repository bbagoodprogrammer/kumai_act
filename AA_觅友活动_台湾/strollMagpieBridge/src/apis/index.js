...
function getInitInfo() {
    ...
    return get(
        `/index.php?action=strollMagpieBridge.init&uid={uid}&token={token}`
    );
}
//进入页面获取邀请我的列表
function creatInivitFriend() {
    return get(
        `/index.php?action=strollMagpieBridge.acceptableInvita&uid={uid}&token={token}`
    );
}
//好友列表
function friendList(from) {
    return get(
        `/index.php?action=strollMagpieBridge.friends&uid={uid}&token={token}&from=${from}`
    );
}
...
function acceptFriend(mail_id) {
    return get(
        `/index.php?action=strollMagpieBridge.accept&uid={uid}&token={token}&mail_id=${mail_id}`
    );
}
...
function rejectFriend() {
    return get(
        `/index.php?action=strollMagpieBridge.reject&uid={uid}&token={token}&mail_id=${mail_id}`
    );
}
...
function rejectRelieve_cj(mail_id) {
    return get(
        `/index.php?action=strollMagpieBridge.rejectRelieve&uid={uid}&token={token}&mail_id=${mail_id}`
    );
}
...
function getAcceptableInvita(mail_id) {
    return get(
        `/index.php?action=strollMagpieBridge.acceptRelieve&uid={uid}&token={token}&mail_id=${mail_id}`
    );
}
...
function inivitFriend(to_uid) {
    return get(
        `/index.php?action=strollMagpieBridge.invite&uid={uid}&token={token}&to_uid=${to_uid}`
    );
}
...
function relieve() {
    return get(
        `/index.php?action=strollMagpieBridge.relieve&uid={uid}&token={token}`
    );
}
...
function giftList() {
    return get(
        `/index.php?action=strollMagpieBridge.giftList&uid={uid}&token={token}`
    );
}
...
function luck_go(is_batch) {
    return get(
        `/index.php?action=strollMagpieBridge.go&uid={uid}&token={token}&is_batch=${is_batch}`
    );
}
...
function lotteryRecord(from) {
    return get(
        `/index.php?action=strollMagpieBridge.giftRecord&uid={uid}&token={token}&from=${from}`
    );
}
...
function joinAct() {
    return get(
        `/index.php?action=strollMagpieBridge.subscribe&uid={uid}&token={token}`
    );
}
