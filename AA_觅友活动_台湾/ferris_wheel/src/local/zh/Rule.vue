  ...
  <div class="rule">
    ...
    <div class="rule_tips" v-if="type == 1">
      ...
      <p>
        ...
        -活動中的日榜榜首的玩家會乘坐上真愛摩天輪，並且獲得【真愛水晶】*2（一人一個），獲獎玩家可獲得當天所得的日榜真愛值的5%加成（加成的分數直接加到總榜，不會加到次日的日榜中）
      </p>
      <h5>4、如何召喚愛神</h5>
    ...
    <div class="gift_tips" v-else>
      ...
      <p>
        -活動中的日榜榜首的玩家會乘坐上真愛摩天輪，並獲得【真愛水晶】*2（一人一個），獲獎玩家可獲得當天所得的日榜真愛值的5%加成（加成的分數直接加到總榜，不會加到次日的日榜中）
      </p>
      <h5>2、總榜獎勵</h5>
      <div class="giftList">
