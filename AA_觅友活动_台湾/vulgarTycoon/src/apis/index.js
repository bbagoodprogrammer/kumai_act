...
function getInitInfo() {
    ...
    return get("/index.php?action=vulgarTycoon.init&uid={uid}&token={token}");
}

function synthesis(prize_id, count) {
    return get(
        `/index.php?action=vulgarTycoon.synthesis&uid={uid}&token={token}&prize_id=${prize_id}&count=${count}`
    );
}
export { get, post, loadData, getInitInfo, synthesis };
