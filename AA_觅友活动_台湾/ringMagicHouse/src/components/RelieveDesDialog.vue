<template>
  <div class="relieve_des_dialog">
    ...
    <div class="select__container">
      ...
      <div class="relieve_des_des">{{ lang.force_release_des_1}}</div>
      <div class="clear_engine">{{ lang.force_release_des_2 }}</div>
      <div class="action__tabs">
        <div class="tab" @click="handleCloseDialog">{{ lang.I_know }}</div>
      </div>
    </div>
  </div>
</template>
...
.relieve_des_dialog {
  ...
  .select__container {
    ...
    .relieve_des_des {
      ...
      color: #ffffff;
      line-height: 0.36rem;
      margin: 0.3rem auto 0.46rem auto;
      text-align: center;
    }
    .clear_engine {
      width: 5.7rem;
