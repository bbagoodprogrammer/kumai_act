<template>
  <div class="rule">
    <div class="actTime">2020/10/15 18:00-11/01 21:00</div>
    <div class="tabs">
    ...
    <div class="ruleTips" v-if="type == 1">
      <h6>積攢酷爽值贏夏日酷爽限定</h6>
      <p>1、報名活動後，收集他人贈送冰可樂、指定禮物和內的任意禮物，可獲得酷爽值<br />
        2、酷爽值=冰可樂酷爽值+派對酷爽值<br />
        冰可樂酷爽值=收到冰可樂數*10<br />
        派對酷爽值=用戶在房間收到指定禮物的價值*12<br />
        3、指定禮物為：驚喜南瓜桶內任意禮物
      </p>
      <h6>排行榜規則</h6>
      <p>1、按照玩家所獲得的酷爽值從高到低進行排名；</p>
    ...
    <div class="giftTips" v-else>
      ...
      <div class="backGift">
        ...
        <strong>魔法城堡背包禮物（50金榜）x2</strong>
      </div>
      <p>日榜前20名，隨機抽出2名獲得XXX背包禮物（50金幣）*2個，將在每天24點抽出中獎者，並直接發放背包禮物到對應背包；活動最後一天的開獎時間和活動結束時間一致</p>
      <h6>2、總榜獎勵</h6>
      <h5>第1-3名</h5>
      ...
      <p>
        第1名：【酷爽寶貝】勛章30天+夏日酷爽背包禮物1個+5000金豆<br />
        第2名：【酷爽寶貝】勛章15天+夏日酷爽背包禮物1個+3000金豆<br />
        第3名：【酷爽寶貝】勛章10天+夏日酷爽背包禮物1個+1000金豆<br />
        第4-6名：南瓜燈背包禮物10個+500金豆<br />
        *玩家通過收夏日酷爽的指定金幣禮物積攢鑽石，鑽石可兌換為金幣
      </p>
      <h6>3、貢獻榜獎勵</h6>
      <div class="gfitBox1 gfitBox">
      ...
      <p>酷爽排行榜前三名的用戶的粉絲貢獻榜中的前三名可獲得貢獻榜獎勵</p>
      <p>儲值返利券（10%）使用說明：在11月1日儲值任意金幣，獲獎者在次日可獲得10%的金幣返利</p>
      <h6>4、送可樂獎勵</h6>
      <p>非小號玩家每送出N瓶冰可樂，可獲得XXX頭像框3天</p>
      <h6>5、進階獎勵</h6>
