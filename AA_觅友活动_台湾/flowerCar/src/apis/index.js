...
function getInitInfo() {
    ...
    return get("/index.php?action=flowerCar.init&uid={uid}&token={token}");
}

function fansList(type, anchor_id, today) {
    return get(
        `/index.php?action=flowerCar.fans&uid={uid}&token={token}&type=${type}&anchor_id=${anchor_id}&today=${today}`
    );
}
export { get, post, loadData, getInitInfo, fansList };
