<template>
  <div class="rankGroups">
    <div class="con_title" v-if="familyCompetition.step == 0">
      {{ lang.comp_start_down_title }}
    </div>
    <div class="con_title" v-else>{{ lang.comp_end_down_title }}</div>
    <div class="time__box">
    ...
    <RankList :list="rank.list" :userRank="rank.userRank" tab="3" />
    <div v-if="rank.loading" class="scrollLoading">{{ lang.loading }}</div>
    <div v-if="rank.none" class="scrollNone" v-html="getBrHtml(lang.comp_coming_soon)"></div>
