<template>
  <div class="words" :class="{active:activateState === 0}">
    <div class="wardsSample">
      <p>ترتيب حسب عدد الأشخاص الذين يعطونك هذه الهدايا المحددة في غرفة الغناء أو لأعمالك ,إذا هناك شخص ما يعطيك هذه الهدايا مرات، يحصى شخصا واحدا فقط لترتيبك</p>
      <!-- <div class="wards">
        <div class="img"></div>
        <div class="wardName">
          <em>珍珠奶茶</em>
...
.words {
  ...
  .wordsList {
    ...
    .listItem {
      ...
      align-items: center;
      margin-top: 0.05rem;
      border-bottom: 0.02rem solid #639160;
      > span {
        width: 0.5rem;
