<template>
  <div class="song">
    <h5>اختيار عملك المرضي لاشتراك في المسابقة</h5>
    ...
    <div class="goSing">
      ...
      <p v-else>لا توجد أغنية ترضيك؟</p>
    ...
    <p class="bMsg">يجب على العمل المشترك في المسابقة أن يكون عملا عاما منشورا بعد 12:00 في يوم 19 من سبتمبر(بتوقيت دبي)</p>
    <Loading></Loading>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    changed() {
      api.singUp(this.songid).then((res) => {
