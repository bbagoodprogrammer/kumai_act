...
export default function openApp(schemaUrl, androidDownUrl, iosDownUrl) {
    schemaUrl = schemaUrl || 'singnowapp://';
    androidDownUrl = androidDownUrl || 'http://singnowapp.com/goto_googleplay';
    iosDownUrl = iosDownUrl || 'http://singnowapp.com/goto_appstore';
    if (ifChrome) {
        if (ifAndroid) {
            setTimeout(function () {
