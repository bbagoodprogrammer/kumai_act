<template>
  <div class="rule">
    ...
    <ol>
      <li>1.ستحصل على نقد الفتحة الواحدة بعد شحن عملة واحدة لاشتراك في اليانصيب. الجوائز في 40 نقد الفتحة و200 نقد الفتحة و500 نقد الفتحة مختلفة، تنفق نقود أكثر، وتكون الجوائز أوفر. ونسبة كسب الجائزة الفريدة أكبر!</li>
      ...
      <li>4.جائزة السيارة الخاصة ل40 نقد الفتحة هي دراجة(سبعة أيام)، جائزة السيارة الخاصة ل200 نقد الفتحة هي دراجة نارية(سبعة أيام)، جائزة السيارة الخاصة ل500 نقد الفتحة هي طائرة الهجوم الحمراء(سبعة أيام)</li>
