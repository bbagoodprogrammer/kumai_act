<template>
  <div class="rule">
    ...
    <ol>
      <li>1.ستحصل على نقد الفتحة الواحدة بعد شحن عملة واحدة لاشتراك في اليانصيب. الجوائز في 400 نقد الفتحة و2000 نقد الفتحة و5000 نقد الفتحة مختلفة، تنفق نقود أكثر، وتكون الجوائز أوفر. ونسبة كسب الجائزة الفريدة أكبر!</li>
      ...
      <li>4.جائزة إطار الصورة الرمزية الخاصة ل400 نقد الفتحة هي جمشت(14 يوم)، جائزة إطار الصورة الرمزية الخاصة ل2000 نقد الفتحة هي قط(14 يوم)، جائزة إطار الصورة الرمزية الخاصة ل5000 نقد الفتحة هي أجنحة السماء(14 يوم)</li>
      <li>5.بعد جري اليانصيب لعشرين مرة في نمط 5000 نقد الفتحة، ستكسب سيارة فيراري(ثلاثون يوما) بالتأكيد!</li>
    </ol>
    ...
    <div class="wardsBox clearfix">
      <ul>
        <li>
          <span>
            <img :src="require('../../assets/img/frame2_rule.png')" alt="">
          </span>
          <p>إطار الصورة الرمزية:قط(14 يوم)</p>
        </li>
        <li>
          <span>
            <img :src="require('../../assets/img/frame3_rule.png')" alt="">
          </span>
          <p>إطار الصورة الرمزية:أجنحة السماء(14 يوم)</p>
        </li>
        <li>
          <span>
        ...
        <li>
          <span>
            <img :src="require('../../assets/img/frame1_rule.png')" alt="">
          </span>
          <p>إطار الصورة الرمزية:جمشت(14 يوم)</p>
        </li>
        <li>
          <span>
