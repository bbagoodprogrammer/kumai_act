<template>
  <div class="kroom" :class="{active:activateState === 0}">
    <div class="wardsSample">
      <p>
        مرتبة حسب قيمة الدعم التراكمي ، وقيمة الدعم = قيمة سحر لجميع المستخدمين في غرفة الغناء بعد التسجيل
      </p>
      <div class="wards">
        <div class="wardsImg">
          <span class="water">
      ...
      <p class="fansong"><em>تلقى هدية الدعم أعلاه ، زادت قيمة سحر بنسبة 5 ٪</em></p>
    </div>
    <div class="wordsList">
      <div class="listTop">
