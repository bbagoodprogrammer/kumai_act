<template>
  <div class="words" :class="{active:activateState === 0}">
    <div class="wardsSample">
      <p>
        الترتيب حسب قيمة الشعبي وهي تعني قيمة سحرية في غرفة الغناء</br>
        عندما تغني ، إذا حصلت على الخمسة الأوائل في ترتيب عدد مانح الهدايا ، فستزداد قيمة شعبيتك بنسبة 1٪ -5٪.
      </p>
      <div class="wards">
        <div class="wardsImg">
          <span class="water">
            <img src="../assets/img/shuijing.png" alt="">
            <em>بالون الدعم<i class="bi"></i><i>10</i></em>
          </span>
          <span class="cun">
            <img src="../assets/img/jiezhi.png" alt="">
            <em>بطاقة الدعم<i class="bi"></i><i>100</i></em>
          </span>
          <span class="car">
            <img src="../assets/img/mdeng.png" alt="">
            <em>التركيز الكامل<i class="bi"></i><i>1255</i></em>
          </span>
        </div>
      </div>
      <p class="fansong"><em>تلقى هدية الدعم أعلاه ، زادت قيمة سحر هدية بنسبة 5 ٪</em></p>
    </div>
    <div class="wordsList">
      <div class="listTop">
      ...
      <div class="nolist" v-if="top.length == 0">لا يوجد الترتيب حتي الآن</div>
    </div>
  </div>
</template>
