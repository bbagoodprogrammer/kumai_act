<template>
  <div class="bigBox">
    ...
    <div class="listTab">
      <a href="" class="works" :class="{active:showComponent === 'works'}" @click.prevent="updateWorks('works')">قائمة الشعبية</a>
      <a href="" class="kRoom" :class="{active:showComponent === 'kRoom'}" @click.prevent="updateKroom('kRoom')">قائمة الدعم</a>
    ...
    <div class="footer">
      ...
      <div class="myMsg" v-show="showComponent === 'works' && (showFooter === 3 || showFooter == 4)">
        ...
        <div class="msgBox">
          ...
          <div class="msgBottom">
            الترتيب : <span>{{WardsMyMsg.rank}}</span>
          </div>
        </div>
        <div class="scoreBox">
          <i class="workScore"></i>
      ...
      <div class="myMsg" v-show="showComponent === 'kRoom' && (showFooter === 3 || showFooter == 4)">
        ...
        <div class="msgBox">
          ...
          <div class="msgBottom">
            الترتيب : <span>{{kRommMyMsg.rank}}</span>
          </div>
        </div>
        <div class="scoreBox">
