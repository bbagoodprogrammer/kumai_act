  ...
  <div class="box">
    ...
    <div class="header">
      ...
      <div class="ruleBox" :class="{top:isShare}">
        <span class="ruleTips" @click="goRule()">الجوائز&القواعد</span>
        <span class="history" @click="goHistory()">تفاصيل المكافأة</span>
      </div>
    </div>
    <integral></integral>
    ...
    <transition name="slide">
      <div class="firstPup" v-if="showFirstGift">
        <div class="firstCon">
          <div class="title"></div>
          <div class="getIntegral" @click="doTask()">ذهاب لكسب النقاط>></div>
          <div class="giftItem">
            <span class="close" @click="closeFirstPup()"></span>
            <div class="giftOne">
              <span>وصول النقاط إلى70</span>
              <div class="imgBox">
                <img src="../assets/img/PupImg/ward0.png" alt="">
              </div>
              <em>{{gift_list.gift_list[0].counts}} فول</em>
            </div>
            <div class="giftOne">
              <span>وصول النقاط إلى90</span>
              <div class="imgBox">
            ...
            <div class="giftOne">
              <span>وصول النقاط إلى150</span>
              <div class="imgBox">
                <img src="../assets/img/PupImg/ward3.png" alt="">
              </div>
              <em>هدية عشوائية من ثلاث هدايا سابقة نلتها اليوم*2</em>
            </div>
          </div>
        </div>
      </div>
