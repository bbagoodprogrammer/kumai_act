  ...
  <div class="song">
    ...
    <div class="determinePup" v-if="showPup">
      <div class="determinCon">
        <p>هل تحدد رفع هذا العمل للاشتراك في النشاط؟</p>
        <div class="chang">
    ...
    <div class="bMsg">
      <p>1.يجب على الأعمال المشتركة أن تنشر بعد 12:00 في يوم 11 من نوفمبر بتوقيت دبي</p>
      <p>2.يمكن رفع أعمالك الكثيرة للاشتراك في النشاط(غير أغنية sing a cappella) سيجري إحصاء هدايا الأعمال بعد تسجيلك</p>
      <p>3.إذا تحذف أعمالك المشتركة في النشاط أثناء وقت النشاط، فدرجاتك لهذه الأعمال تكون تافهة</p>
    </div>
    <Loading></Loading>
  </div>
</template>
