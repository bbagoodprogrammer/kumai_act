<template>
  <div class="history">
    <div class="title">تفاصيل المكافأة</div>
    <div class="giftlist">
      <div class="listTitle">
        <span class="time">الوقت</span>
        <span class="gift">المكافآت</span>
      </div>
      <ul class="scrollable">
      ...
      <p v-if="record.length == 0" class="noDate">لا توجد تفاصيل المكافأة الآن</p>
    </div>
    <Loading></Loading>
  </div>
</template>
