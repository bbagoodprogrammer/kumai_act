<template>
  <div class="history1">
    <p v-if="history1.list && history1.list.length == 0" class="tips">لا توجد الرغبات الآن</p>
    <ul class="scrollable" v-else>
      <li v-for="(item,index) in history1.list" :key="index">
        ...
        <p class="tips">أكمل أغنيتك الرغبية</p>
        <div class="auido">
        ...
        <div class="score">
          <p class="scoreTitle">إعطاء الدرجات</p>
          <div class="scoreBox">
      ...
      <p v-show="loading" class="loadingTips">في التحميل...</p>
    </ul>
