<template>
  <div class="rule">
    ...
    <div class="ruleMsg" v-show="showTab == 'tab1'">
      ...
      <p class="red">4. بعد قطف الرغبة، تفضل بإرسال الأغنية الرغبتية خلال 12 ساعة، أو إلا ستعيد هذه الأغنية الرغبتية إلى حالة انتظار القطف وتعيد إلى قائمة الرغبات</p>
      <p>5.لا يمكن أن تشترك في هذا النشاط بحسابات كثيرة.</p>
      <p>6.أثناء النشاط، إذا يوجد عشرة أشخاص يعطون درجة واحدة لأغانيك أو تحذف أغانيك الرغبية لخمس مرات، فستُمنع من قطف رغبة الآخرين. وفي نفس الوقت، سنمسح نقاطك في قائمة إكمال الرغبة، ولا يمكنك دخول هذه القائمة</p>
      <p>7.يمكن أن تقطف 10 رغبات على أقصى الحد</p>
      <h5>الملاحظات:</h5>
