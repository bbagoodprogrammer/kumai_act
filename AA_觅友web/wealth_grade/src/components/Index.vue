...
body{
  width: 7.50rem;
  background: linear-gradient(136deg, #381A53 0%, #252B68 15%, #381A53 47%, #252B68 100%);
  opacity: 1;
  padding-bottom: .5rem;
  line-height: 1;
}
    ...
    .progress_box{
      ...
      .lv{
        ...
        span:nth-of-type(1){
          ...
          strong:nth-of-type(1),strong:nth-of-type(3){
            line-height: .40rem;
            font-weight: bold;
            font-size: .28rem;
  ...
  .privilege{
    ...
    .icon_box{
      ...
      .list{
        ...
        width: 2rem;
        height: 2.93rem;
        background: linear-gradient(180deg, rgba(114, 88, 254, 0) 0%, rgba(114, 88, 254, 0.2) 100%);
...
.pro_level,.pro_float,.pro_service {
  position: fixed;
  left: 0;
  top: 0;
  right: 0;
