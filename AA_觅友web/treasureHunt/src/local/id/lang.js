...
export default {
    ...
    get: "Dapat",
    treasure_one: "Cari 1 kali",
    treasure_ten: "Cari 10 kali",
    ...
    adventure_first_des:
        "Paket Harta Super (gelar+bingkai avatar+mount+lencana) 7 hari",
    adventure_second: "Top 2~3",
    adventure_second_des:
        "Paket Pencarian Harta (bingkai avatar+lencana) 7 hari",
    adventure_rest: "Top 4~10",
    adventure_rest_des: "Lencana Pencarian Harta 7 hari",
    prop_get_rate: "Probabilitas alat peraga",
    general_treasure_hunt: "Pencarian Harta Biasa",
    ...
    other_explain_3:
        "Dilarang melakukan perilaku apapun yang memengaruhi keadilan interaksi, atau menggunakan platform BUG dan metode lain yang tidak pantas untuk berpartisipasi dalam acara. Setelah ditemukan, platform berhak membatalkan pemberian alat peraga dan ambil kembali alat peraga.",
    other_explain_4:
        "Acara ini tidak berhubungan dengan Apple, dan hak interpretasi akhir adalah milik AloChat.",

    get_treasure_map: "Dapatkan peta harta",
    map_num: "%s",
    get_map: "Membeli",
    get_map_des: "Membayar {0} koin emas untuk dapatkan {1} peta harta",
    store: "Topup",
    ...
    adventure_list: "Daftar Mingguan",
    weekly_award: "Gift",
    weekly_award_title:
        "Daftar ini akan dihitung pada setiap Hari Senin pukul 00:00(wib). Dapatkan hadiah yang relevan sesuai dengan peringkat daftar. Mencari harta 1 kali akan menambahkan sebesar 100 nilai petualangan.",
    this_week: "Minggu ini",
    last_week: "Minggu lalu",
    list_adventure_value: "%s Nilai petualangan",
    distance_last: "Jarak %s nilai dr peserta sebelumnya",
