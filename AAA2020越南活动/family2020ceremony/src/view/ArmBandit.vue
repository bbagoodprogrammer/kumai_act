  ...
  <div class="box">
    ...
    <div class="header">
      <div class="tipsBox" :class="{top:isShare}">
        <span class="rank" @click="goMain()">Hội trường >></span>
...
export default {
  ...
  methods: {
    ...
    async bannerGo() {
      ...
      const fileData = await downloader.get(`http://fstatic.cat1314.com/uc/svga/daeb6cb2f3d4c8641c1df193ac034a92_1608023795.svga`);
