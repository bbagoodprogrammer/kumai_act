    ...
    <div class="acrStatus" :class="{noBg:astState === 3 && showType == 2 && !nowUsrMsg.pk_data}">
      ...
      <div class="noKroom" v-if="astState === 3">
        ...
        <div class="creatMsg">
          ...
          <div class="msg">
            <div class="scoreTips">Mị lực xu phòng Kara</div>
            <div class="score">{{charm}}</div>
            <div class="bar">Tiến độ nhận quà
              <div class="liner">
          ...
          <div class="creatBtn">
            ...
            <div class="join" @click="goFamily()">Vào gia tộc</div>
          </div>
        </div>
      </div>
    ...
    <div class="mask" v-show="showQuery">
      <transition name="slide">
        <div class="qureyPup" v-show="showQuery">
          ...
          <p>Bạn chưa có gia tộc, xin hỏi bạn cần</p>
          <div class="btnBox">
    ...
    <div class="mask" v-show="showCommitPup">
      <transition name="slide">
        <div class="commitMsg" v-show="showCommitPup">
          ...
          <h3>Gọi thành viên</h3>
          <div class="title">Thông báo</div>
          <input id='msg' maxlength="20" v-model="comMsg" />
          <div class="title">ID Phòng (tuỳ chọn)</div>
          <input id='rid' maxlength="10" v-model="comRid" />
          <div class="tipsBox" v-if="sendType == 3">
            Tháng này được gọi {{nowUsrMsg.nums}} lần<br />
            Thành viên nhận thông báo và nhấn vào sẽ đến trang hoặc phòng gia tộc<br />
            Nếu điền ID, thành viên nhấn vào sẽ đến phòng Kara chỉ định, mời điền đúng ID
          </div>
          <div class="tipsBox" v-else-if="sendType == 1">
            Gia tộc đạt cấp 10 sẽ mở khoá tính năng này
          </div>
