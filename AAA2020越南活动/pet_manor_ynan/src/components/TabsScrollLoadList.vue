<template>
  <div class="rankGroups">
    ...
    <div class="mainTabs">
      <div class="tabs">
        <a @click.prevent="mainTabClick(0)" :class="{current:mainTab==0}" href="">BXH Mị Lực</a>
        <a @click.prevent="mainTabClick(1)" :class="{current:mainTab==1}" href="">BXH Thú Cưng</a>
      </div>
      <a @click.prevent="onRefresh" href="" :style="{transform:'rotate('+rotatePx+'deg)'}" id="refresh"></a>
    </div>
    <div class="tabsTips">
      <p v-if="mainTab==0" class="taotalTips">Xếp hạng theo tổng mị lực của toàn bộ quà thú cưng<br />Mỗi khi thu thập đủ thú cưng 1 lần (6 loại) <br /> thưởng them 1000 mị lực</p>
      <div class="petTips" v-else>
        ...
        <p class="tips">Xếp hạng theo quà {{pets[tab].name}} đã nhận, top 10 nhận thưởng</p>
      </div>
    </div>
    ...
    <div class="listTipsBox">
      ...
      <div v-if="rank.none " class="scrollNone">
        Bạn bè chưa có hạng </br>
        Còn trống, đang đợi bạn đó!
      </div>
    </div>
  </div>
</template>
