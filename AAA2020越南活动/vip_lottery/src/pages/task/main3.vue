        ...
        <ul class="scrollable">
          <li v-for="(item,index) in taskList" :key="index">
            ...
            <span class="state">
              ...
              <em v-else-if="item.status == 1" class="lingqu" @click="getGift(item.id,index)">{{lang.coinsTwo}}</em>
...
export default {
  ...
  computed: {
    shareLink() {
      return `http://activity.singnowapp.com/static_html/2020/vip_lottery/index.html?code=${this.code}`
    }
  },
  methods: {
    getGift(id, index) {
    ...
    share(code) {
      ...
      var data = {
        "share_title": "Tôi đang làm nhiệm vụ bí ấn trong Tuần Đặc Quyền Hội Viên!",
        "share_content": "Hãy điền mã mời để hỗ trợ tôi nhé!",
        "share_image": "http://activity.singnowapp.com/static_html/2020/vip_lottery/share.jpg",
        "link": `http://activity.singnowapp.com/static_html/2020/vip_lottery/index.html?uid=${uid}&code=${code}&v=2`,
        "image": "http://activity.singnowapp.com/static_html/2020/vip_lottery/share.jpg",
        "share_url": `http://activity.singnowapp.com/static_html/2020/vip_lottery/index.html?uid=${uid}&code=${code}&v=2`
      }
      if (ios) {
        this.code = code
        this.showShare = true
