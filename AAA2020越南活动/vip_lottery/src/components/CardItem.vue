...
export default {
  ...
  computed: {
    ...
    shareLink() {
      return `http://activity.singnowapp.com/static_html/2020/vip_lottery/index.html?code=${this.luckGift.invite_code}`
    }
  },
  methods: {
    goCard() {
    ...
    share(code) {
      globalBus.$emit('commonEvent', callback => {
        ...
        var data = {
          ...
          "link": `http://activity.singnowapp.com/static_html/2020/vip_lottery/index.html?uid=${this.userMsg.uid}&code=${code}&v=2`,
          "image": "http://activity.singnowapp.com/static_html/2020/vip_lottery/share.jpg",
          "share_url": `http://activity.singnowapp.com/static_html/2020/vip_lottery/index.html?uid=${this.userMsg.uid}&code=${code}&v=2`
        }
        if (ios) {
          this.showShare = true
