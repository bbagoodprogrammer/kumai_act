<template>
  <div class="giftBox">
    ...
    <div class="giftTips">
      *Mỗi ngày đạt đến cấp tương ứng sẽ có thể nhận quà tương ứng, mỗi ngày mỗi cấp có thể nhận 1 lần, chỉ nhận trong ngày.
    </div>
    ...
    <div class="mask" v-show="giftPup">
      <transition name="slide">
        <div class="giftShow" v-if="giftPup">
          ...
          <div class="tipsBox">
            <p>1.Mỗi ngày đạt đến cấp tương ứng sẽ có thể nhận quà tương ứng, mỗi ngày mỗi cấp có thể nhận 1 lần, chỉ nhận trong ngày. </p>
      ...
      giftList: [
        {
          ...
          name: 'Huy chương Người Đại Diện Nguyên Tiêu'
        },
        {
          imgIcon: require('../assets/img/gifts/gift10.png'),
          name: 'Trang sức Song Ngư'
        },
        {
