<template>
  <div class="rule">
    ...
    <div class="ruleTips" v-if="tab == 1">
      ...
      <p>Hạng 2:<br />Huy chương Người Đại Diện Nguyên Tiêu (30 ngày) + Trang sức Song Ngư (30 ngày) + Kỳ Lân Năm Mới (30 ngày) + VIP (30 ngày)+ 2 Túi quà Tết Nguyên Tiêu (129 xu) + 2500 xu + 5000 đậu</p>
      <p>Hạng 3:<br />Huy chương Người Đại Diện Nguyên Tiêu (30 ngày) + Trang sức Song Ngư (30 ngày) + Kỳ Lân Năm Mới (30 ngày) + VIP (30 ngày)+ 2 Túi quà Tết Nguyên Tiêu (129 xu) + 2000 xu + 4000 đậu</p>
      <p>Hạng 4-5<br />Huy chương Người Đại Diện Nguyên Tiêu (30 ngày) + Kỳ Lân Năm Mới (30 ngày) + VIP (30 ngày)+ 1 Túi quà Tết Nguyên Tiêu (129 xu) + 1500 xu + 3000 đậu</p>
      <p>Hạng 6-10:<br />Kỳ Lân Năm Mới (30 ngày) + VIP (30 ngày)+ 1 Túi quà Tết Nguyên Tiêu (129 xu) + 1000 xu + 2000 đậu</p>
      <p>Hạng 11-20:<br />1 Túi quà Tết Nguyên Tiêu (129 xu) + 500 xu + 500 đậu</p>
      <h5>Thể lệ phần thưởng</h5>
      <p>1、Túi quà sự kiện này có thời hạn 7 ngày, hãy nhanh chóng sử dụng.</p>
    ...
    <div class="giftItem" v-else>
      ...
      <p>
        1.Tổng cộng có 4 rương, điểm sao lần lượt đạt đến 100, 1500, 4000, 7000, có thể rút được rương tương ứng, mỗi lần rút sẽ nhận được 3 phần quà. Phần thưởng sẽ tự động gửi vào tài khoản, mỗi người mỗi ngày chỉ có thể rút cùng 1 rương 1 lần<br />
      ...
      <p>
        1. Trong thời gian sự kiện, tác phẩm có nhãn [Thách Đấu Người Đại Diện] mỗi lần nhận được 300 Chè Trôi Nước (20 xu), sẽ nổ 1 lần lì xì may mắn 666 xu, mỗi lần nổ lì xì 200 cái, đến trước có trước.<br />
        2、Sau khi nhấn [Hẹn cướp lì xì], khi nổ lì xì sẽ nhận được thông báo từ hệ thống, nhấn [Hủy hẹn], sẽ không nhận được thông báo nổ lì xì nữa.
      </p>
