<template>
  <div class="box">
    ...
    <div class="header">
      ...
      <div class="tipsBox">
        <span class="tips ruleTips" :class="{top:isShare}" @click="goRule()">Thể <br />lệ</span>
        <span class="tips songList" @click="showRank()">BXH<br /> bài hát</span>
        <span class="tips myHistory" @click="goHistory()">Lịch<br /> sử</span>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      svgaAddress: {
        Bg: {
          addres: "http://img.17sing.tw/uc/activity/e92153046bebcd991595fe5fbfabfe5d_1594793325.svga", //背景
          isStop: false
        },
        BgBtn: {
        ...
        bottle: {
          addres: "http://img.17sing.tw/uc/activity/09b56fe63de86dd98e83384adffc72ca_1594258460.svga", //瓶子
          isStop: false
        }
      },
      plarerArr: {}
  ...
  methods: {
    ...
    creatBgMusic() {
      this.bgSound = new Howl({
        ...
        onloaderror: () => {
          this.toast(`Tải nhạc thất bại, mời thử lại sau`)
        }
      });
    },
    setBgSound() {
