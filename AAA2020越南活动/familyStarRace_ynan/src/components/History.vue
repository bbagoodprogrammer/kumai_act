<template>
  <div class="hsitoryList">
    ...
    <div class="title">Chi tiết thưởng</div>
    <div class="listTitle">
      <span class="num">Mục</span>
      <span class="nick">Người nhận</span>
      <span class="uid">UID</span>
      <span class="gift">Thưởng</span>
    </div>
    <p v-if="hList.length == 0" class="noData">Chưa có dữ liệu</p>
    <ul class="scrollable">
