<template>
  <div class="rule">
    ...
    <div class="ruleItem" v-if="type==1">
      ...
      <p>4. Sau khi cuộc thi kết thúc trong vòng 7 ngày nhân viên của app sẽ liên hệ tộc trưởng để lấy thông tin phát thưởng, nếu quá hạn không nhận được phản hồi từ tộc trưởng xem như bỏ phần thưởng.</p>
