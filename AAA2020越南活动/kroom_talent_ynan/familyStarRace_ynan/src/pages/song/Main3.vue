<template>
  <div class="song">
    <h5 v-if="isLength">Chọn bài hát bạn ưng ý dự thi nhé</h5>
    <h5 class="noSong" v-else>Bạn chưa có bài hát phù hợp yêu cầu</h5>
    ...
    <div class="goSing" :class="{border:isLength}">
      <p v-if="isLength> 0">Không có bài hát ưng ý?</p>
      <div class="sing" @click="goSing()">Hát 1 bài</div>
      <span>Hát xong nhớ trở lại báo danh nhé</span>
    </div>
    <p class="tips"> 1. Bài hát dự thi phải là bài hát công khai đăng sau <em>00:00:00 14/11</em> (trừ hát chay 5 phút)</p>
    ...
    <div class="determinePup" v-if="showPup">
      <div class="determinCon">
        <p>Xác nhận dự thi bài này không?</p>
        <div class="chang">
