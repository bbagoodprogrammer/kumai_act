...
export default {
  ...
  methods: {
    ...
    goMain() {
      ...
      location.href = `http://activity.singnowapp.com/static_html/2020/ceremony202000/index.html?token=${regstr}&uid=${uid}&aid=${aid}`
    },
    goRule() {
      let uid = getString('uid')
      let regstr = getString('token')
    ...
    goTicket() {
      ...
      let regstr = getString('token')
      let aid = getString('aid')
      location.href = `http://activity.singnowapp.com/static_html/2020/singervote2020/index.html?token=${regstr}&uid=${uid}&aid=${aid}`
    },
    refrsh() { //刷新
