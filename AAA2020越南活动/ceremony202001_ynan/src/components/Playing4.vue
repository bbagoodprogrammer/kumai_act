<template>
  <div class="playing4">
    <div class="storedTips">
      ...
      <p v-if="type==1">Trong ngày Lễ Tạ Ơn 26/11 nạp xu mức bất kỳ được tặng thêm 12% số xu nạp (không bao gồm xu tặng từ hệ thống), nạp nhiều thưởng nhiều! Trong thời gian sự kiện sau khi nạp thành công sẽ nhận ngay xu thưởng!</p>
      <p v-else> Trong ngày Lễ Giáng Sinh 25/12 nạp xu mức bất kỳ được tặng thêm 12% số xu nạp (không bao gồm xu tặng từ hệ thống), nạp nhiều thưởng nhiều! Trong thời gian sự kiện sau khi nạp thành công sẽ nhận ngay xu thưởng!</p>
