...
export default {
  data() {
    return {
      taskName: {
        login: 'Đăng nhập',
        publicWork: 'Đăng 1 bài hát công khai do chính mình hát',
        noDel: 'Bài hát đăng công khai hôm trước chưa bị xoá',
        like5: 'Thích 5 bài hát khác nhau',
        stayKtv: 'Vào phòng Kara không khoá 20 phút',
        sing: 'Lên mic tại phòng Kara không khoá 60 giây',
        sendBean: 'Tặng quà 100 đậu',
        getGift: 'Nhận 800 mị lực quà xu',
        charge: 'Nạp 100 xu',
